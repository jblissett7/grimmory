...
class BookFileGroupingUtilsTest {
  ...
  void extractGroupingKey_shouldStripFormatIndicators() {
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit (PDF).pdf"))
        .isEqualTo("the hobbit");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit (EPUB).epub"))
        .isEqualTo("the hobbit");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit [pdf].pdf"))
        .isEqualTo("the hobbit");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit [EPUB].epub"))
  ...
  void extractGroupingKey_shouldNotStripNonFormatParentheses() {
    assertThat(BookFileGroupingUtils.extractGroupingKey("Book (Extended Edition).pdf"))
        .isEqualTo("book (extended edition)");
  }

  @Test
  void generateDirectoryGroupKey_shouldCombineSubPathAndGroupingKey() {
    String key =
        BookFileGroupingUtils.generateDirectoryGroupKey("fantasy/tolkien", "The Hobbit.pdf");
  ...
  void groupByBaseName_shouldGroupFilesWithSameBaseNameInSameDirectory() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(epub, pdf));
  ...
  void groupByBaseName_shouldSeparateFilesInDifferentDirectories() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(file1, file2));
  ...
  void extractGroupingKey_shouldConvertUnderscoresToSpaces() {
    ...
    assertThat(BookFileGroupingUtils.extractGroupingKey("Lord_of_the_Rings.epub"))
        .isEqualTo("lord of the rings");
  }

  @Test
  void extractGroupingKey_shouldStripTrailingAuthor() {
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit - J.R.R. Tolkien.pdf"))
        .isEqualTo("the hobbit");
    assertThat(BookFileGroupingUtils.extractGroupingKey("1984 - George Orwell.epub"))
        .isEqualTo("1984");
    assertThat(BookFileGroupingUtils.extractGroupingKey("Pride and Prejudice - Jane Austen.pdf"))
  ...
  void extractGroupingKey_shouldRepositionArticles() {
    ...
    assertThat(BookFileGroupingUtils.extractGroupingKey("Tale of Two Cities, A.epub"))
        .isEqualTo("a tale of two cities");
    assertThat(BookFileGroupingUtils.extractGroupingKey("Unexpected Journey, An.pdf"))
        .isEqualTo("an unexpected journey");
  }

  @Test
  void extractGroupingKey_shouldHandleCombinedNormalizations() {
    // Underscores + author
    assertThat(BookFileGroupingUtils.extractGroupingKey("The_Hobbit - J.R.R. Tolkien.pdf"))
        .isEqualTo("the hobbit");
    // Article + author
    assertThat(BookFileGroupingUtils.extractGroupingKey("Hobbit, The - J.R.R. Tolkien.pdf"))
        .isEqualTo("the hobbit");
    // Underscores + article
  ...
  void groupByBaseName_shouldGroupExtendedNamesMatchingFolderName() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(epub, mobi, m4b));
  ...
  void groupByBaseName_shouldGroupEditionVariantsWithFolderName() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(regular, anniversary, unabridged));

    assertThat(groups).hasSize(1);
    assertThat(groups.values().iterator().next())
        .containsExactlyInAnyOrder(regular, anniversary, unabridged);
  }
  ...
  void groupByBaseName_shouldKeepSeriesEntriesSeparate() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(book1, book2, book3));
  ...
  void groupByBaseName_shouldKeepSeriesWithNumbersSeparate() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(vol1, vol2));
  ...
  void groupByBaseName_shouldGroupSeriesFormatsWithSameNumber() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(book1epub, book1pdf, book2epub));

    assertThat(groups).hasSize(2);
    // Book 1 should have 2 files
    boolean foundBook1Group =
  ...
  void groupByBaseName_shouldSeparateUnrelatedBooksInAuthorFolder() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(americanGods, coraline, stardust));
  ...
  void groupByBaseName_shouldUseExactMatchingForRootLevelFiles() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(epub, pdf, other));

    assertThat(groups).hasSize(2);
    // Hobbit files should be grouped
    boolean foundHobbitGroup =
        groups.values().stream()
  ...
  void groupByBaseName_shouldGroupFilesWithAuthorVariationsMatchingFolder() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(basic, withAuthor));
  ...
  void extractGroupingKey_shouldStripPartIndicators() {
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Lost Hero (part 1).m4b"))
        .isEqualTo("the lost hero");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Lost Hero (pt 2).m4b"))
        .isEqualTo("the lost hero");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Lost Hero (disc 1).m4b"))
        .isEqualTo("the lost hero");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Lost Hero [cd 3].m4b"))
        .isEqualTo("the lost hero");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Lost Hero - part 1.m4b"))
        .isEqualTo("the lost hero");
  }
  ...
  void groupByBaseName_shouldKeepBarePartSeriesEntriesSeparate() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(part1, part2));
  ...
  void groupByBaseName_shouldHandleMixedPartsAndSeparateBooks() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(lostHeroPt1, lostHeroPt2, sonOfNeptune));

    assertThat(groups).hasSize(2);
    boolean foundLostHeroGroup =
        groups.values().stream()
            .anyMatch(
                list -> list.size() == 2 && list.containsAll(List.of(lostHeroPt1, lostHeroPt2)));
  ...
  void groupByBaseName_shouldHandleFolderBasedAudiobook() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(epub, mp3Folder));
  ...
  void groupByBaseName_shouldHandleNestedFolderPath() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(epub, m4b));
  ...
  void groupByBaseName_shouldGroupNestedAudiobookFolderWithEbooks() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(pdf, epub, audiobookFolder));

    // All should be grouped together
    assertThat(groups).hasSize(1);
    assertThat(groups.values().iterator().next())
        .containsExactlyInAnyOrder(pdf, epub, audiobookFolder);
  }
  ...
  void groupByBaseName_shouldGroupAudiobookVariantNames() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(epub, audiobook1));
  ...
  void extractGroupingKey_shouldStripBareDiscAndCdAndPt() {
    ...
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit disc 1.m4b"))
        .isEqualTo("the hobbit");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit disk 2.m4b"))
        .isEqualTo("the hobbit");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit cd 3.m4b"))
        .isEqualTo("the hobbit");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit pt 1.m4b"))
        .isEqualTo("the hobbit");
  }

  @Test
  void extractGroupingKey_shouldStripPartInSquareBrackets() {
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit [part 1].m4b"))
        .isEqualTo("the hobbit");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit [Part 2].m4b"))
        .isEqualTo("the hobbit");
  }
  ...
  void extractGroupingKey_shouldNotStripPartWithoutNumber() {
    ...
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Best Part.epub"))
        .isEqualTo("the best part");
    assertThat(BookFileGroupingUtils.extractGroupingKey("Disc Jockey.m4b"))
        .isEqualTo("disc jockey");
  }

  @Test
  void extractGroupingKey_shouldStripAudioFormatIndicators() {
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit (m4b).m4b"))
        .isEqualTo("the hobbit");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit (mp3).mp3"))
        .isEqualTo("the hobbit");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit [audiobook].m4b"))
        .isEqualTo("the hobbit");
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit (audio).m4b"))
        .isEqualTo("the hobbit");
  }
  ...
  void extractGroupingKey_shouldStripFormatThenPartIndicator() {
    ...
    assertThat(BookFileGroupingUtils.extractGroupingKey("The Hobbit (mp3) (part 1).mp3"))
        .isEqualTo("the hobbit");
  }
  ...
  void extractGroupingKey_shouldPreserveBareNumberDotPrefix() {
    ...
    assertThat(BookFileGroupingUtils.extractGroupingKey("01. The Lightning Thief.m4b"))
        .isEqualTo("01. the lightning thief");
    assertThat(BookFileGroupingUtils.extractGroupingKey("100. War and Peace.epub"))
        .isEqualTo("100. war and peace");
  }
  ...
  void extractGroupingKey_shouldNotTreatNumberWithoutSeparatorAsPrefix() {
    ...
    assertThat(BookFileGroupingUtils.extractGroupingKey("101 Dalmatians.epub"))
        .isEqualTo("101 dalmatians");
  }
  ...
  void groupByBaseName_shouldGroupSameBareNumberInMultipleFormats() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(epub, m4b, epub2));
  ...
  void groupByBaseName_shouldSeparateEpisodeSeriesEntries() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(ep1, ep2));
  ...
  void groupByBaseName_shouldGroupBracketedPartsAtRootLevel() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(pt1, pt2));
  ...
  void groupByBaseName_shouldGroupDiscVariantsOfSameBook() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(d1, d2, d3));
  ...
  void groupByBaseName_shouldGroupCdVariantsOfSameBook() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(cd1, cd2));
  ...
  void groupByBaseName_shouldSeparateCompletelyUnrelatedFilesInFolder() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(war, moby, pride));
  ...
  void groupByBaseName_shouldHandleFullHeroesOfOlympusScenario() {
    ...
    LibraryFile moa1 =
        LibraryFile.builder()
            .libraryPathEntity(pathEntity)
            .fileSubPath("Heroes of Olympus")
            .fileName("3. The Mark of Athena (part 1).m4b")
            .bookFileType(BookFileType.AUDIOBOOK)
            .build();
    LibraryFile moa2 =
        LibraryFile.builder()
            .libraryPathEntity(pathEntity)
            .fileSubPath("Heroes of Olympus")
            .fileName("3. The Mark of Athena (part 2).m4b")
            .bookFileType(BookFileType.AUDIOBOOK)
            .build();
    LibraryFile hoh =
        LibraryFile.builder()
            .libraryPathEntity(pathEntity)
            .fileSubPath("Heroes of Olympus")
            .fileName("4. The House of Hades.m4b")
            .bookFileType(BookFileType.AUDIOBOOK)
            .build();
    LibraryFile boo =
        LibraryFile.builder()
            .libraryPathEntity(pathEntity)
            .fileSubPath("Heroes of Olympus")
            .fileName("5. The Blood of Olympus.m4b")
            .bookFileType(BookFileType.AUDIOBOOK)
            .build();

    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(lh1, lh2, son, moa1, moa2, hoh, boo));

    // 5 books: Lost Hero (2 parts grouped), Son of Neptune, Mark of Athena (2 parts grouped), House
    // of Hades, Blood of Olympus
    assertThat(groups).hasSize(5);
    boolean lhGrouped =
        groups.values().stream().anyMatch(l -> l.size() == 2 && l.containsAll(List.of(lh1, lh2)));
    boolean moaGrouped =
        groups.values().stream().anyMatch(l -> l.size() == 2 && l.containsAll(List.of(moa1, moa2)));
  ...
  void groupByBaseName_shouldGroupFolderWithDotInName() {
    ...
    Map<String, List<LibraryFile>> groups =
        BookFileGroupingUtils.groupByBaseName(List.of(epub, mobi, m4b, mp3Folder));

    // All 4 files should be grouped as one book
    assertThat(groups).hasSize(1);
    assertThat(groups.values().iterator().next())
        .containsExactlyInAnyOrder(epub, mobi, m4b, mp3Folder);
  }
}

...
public class LibraryTestBuilderAssert
    extends AbstractAssert<LibraryTestBuilderAssert, LibraryTestBuilder> {
  ...
  public LibraryTestBuilderAssert hasNoAdditionalFiles() {
    ...
    Assertions.assertThat(additionalFiles).isEmpty();

    return this;
  }

  public LibraryTestBuilderAssert bookHasAdditionalFormats(
      String bookTitle, BookFileType... additionalFormatTypes) {
    var book = actual.getBookEntity(bookTitle);
    Assertions.assertThat(book)
        .describedAs("Book with title '%s' should exist", bookTitle)
        .isNotNull();

    List<BookFileType> additionalFormatTypesActual =
    ...
    Assertions.assertThat(additionalFormatTypesActual)
        .describedAs(
            "Book '%s' should have additional formats: %s", bookTitle, additionalFormatTypes)
        .containsExactlyInAnyOrder(additionalFormatTypes);

    return this;
  }

  public LibraryTestBuilderAssert bookHasSupplementaryFiles(
      String bookTitle, String... supplementaryFiles) {
    var book = actual.getBookEntity(bookTitle);
    Assertions.assertThat(book)
        .describedAs("Book with title '%s' should exist", bookTitle)
        .isNotNull();

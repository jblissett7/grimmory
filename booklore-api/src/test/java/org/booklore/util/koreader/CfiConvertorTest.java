...
class CfiConvertorTest {
  ...
  class ExtractSpineIndexTests {
    ...
    void extractSpineIndex_nullOrEmpty_throwsException(String input) {
      assertThrows(IllegalArgumentException.class, () -> CfiConvertor.extractSpineIndex(input));
    }
  ...
  class XPointerToCfiTests {
    ...
    void xPointerToCfi_invalidPath_throwsException() {
      ...
      assertThrows(IllegalArgumentException.class, () -> converter.xPointerToCfi("/invalid/path"));
    }
  }
  ...
  class CfiToXPointerTests {
    ...
    void cfiToXPointer_spineIndexMismatch_throwsException() {
      ...
      assertThrows(IllegalArgumentException.class, () -> converter.cfiToXPointer(cfi));
    }
    ...
    void cfiToXPointer_invalidCfiFormat_throwsException() {
      ...
      assertThrows(
          IllegalArgumentException.class, () -> converter.cfiToXPointer("not-a-valid-cfi"));
    }
    ...
    void cfiToXPointer_malformedCfi_throwsException() {
      ...
      assertThrows(
          IllegalArgumentException.class, () -> converter.cfiToXPointer("epubcfi(invalid)"));
    }
  }

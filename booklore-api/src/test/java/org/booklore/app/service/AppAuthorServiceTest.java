...
class AppAuthorServiceTest {
  ...
  void setUp() {
    service =
        new AppAuthorService(authorRepository, authenticationService, fileService, entityManager);
  }
  ...
  class GetAuthorsTests {
    ...
    void getAuthors_admin_noFilters_returnsPage() {
      ...
      AppPageResponse<AppAuthorSummary> result =
          service.getAuthors(0, 30, "name", "asc", null, null, null);
    ...
    void getAuthors_nonAdmin_withAccessibleLibrary_succeeds() {
      ...
      mockCountQuery(1L);
      mockDataQuery(List.<Object[]>of(new Object[] {buildAuthor(3L, "Author C"), 2L}));
      mockAuthorThumbnailExists(3L, false);

      AppPageResponse<AppAuthorSummary> result =
          service.getAuthors(0, 30, null, null, 5L, null, null);
    ...
    void getAuthors_nonAdmin_noLibraryFilter_usesAccessibleLibraries() {
      ...
      mockCountQuery(1L);
      mockDataQuery(List.<Object[]>of(new Object[] {buildAuthor(4L, "Author D"), 1L}));
    ...
    void getAuthors_withSearch_filtersResultsByName() {
      mockAdminUser();
      mockCountQuery(1L);
      mockDataQuery(List.<Object[]>of(new Object[] {buildAuthor(5L, "Brandon Sanderson"), 12L}));
      mockAuthorThumbnailExists(5L, true);

      AppPageResponse<AppAuthorSummary> result =
          service.getAuthors(0, 30, null, null, null, "brandon", null);
    ...
    void getAuthors_withHasPhotoTrue_filtersToAuthorsWithPhotos() {
      ...
      AppPageResponse<AppAuthorSummary> result =
          service.getAuthors(0, 30, null, null, null, null, true);
    ...
    void getAuthors_withHasPhotoFalse_filtersToAuthorsWithoutPhotos() {
      ...
      AppPageResponse<AppAuthorSummary> result =
          service.getAuthors(0, 30, null, null, null, null, false);
    ...
    void getAuthors_paginationDefaults_appliedCorrectly() {
      ...
      AppPageResponse<AppAuthorSummary> result =
          service.getAuthors(null, null, null, null, null, null, null);
    ...
    void getAuthors_pageSizeCapped_atMax() {
      ...
      AppPageResponse<AppAuthorSummary> result =
          service.getAuthors(0, 100, null, null, null, null, null);
    ...
    void getAuthors_sortByBookCount_desc() {
      ...
      AppPageResponse<AppAuthorSummary> result =
          service.getAuthors(0, 30, "bookCount", "desc", null, null, null);
    ...
    void getAuthors_sortByRecent_desc() {
      ...
      AppPageResponse<AppAuthorSummary> result =
          service.getAuthors(0, 30, "recent", "desc", null, null, null);
  ...
  private void mockAuthorThumbnailExists(Long authorId, boolean exists) {
    ...
    if (exists) {
      ...
      when(fileService.getAuthorThumbnailFile(authorId))
          .thenReturn(System.getProperty("java.io.tmpdir"));
    }
  }

  private AuthorEntity buildAuthor(Long id, String name) {
    return AuthorEntity.builder().id(id).name(name).build();
  }
}

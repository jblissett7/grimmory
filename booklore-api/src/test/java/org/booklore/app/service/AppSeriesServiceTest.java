...
class AppSeriesServiceTest {
  ...
  class GetSeriesTests {
    ...
    void getSeries_admin_noParams_returnsPage() {
      mockAdminUser();
      mockAggregateQuery(List.of(mockSeriesTuple("The Expanse", 9L, 9, Instant.now(), 3L)));
      mockCountQuery(1L);
      mockBooksQuery(List.of(buildBook(1L, "The Expanse", 1.0f, "Author A")));

      AppPageResponse<AppSeriesSummary> result =
    ...
    void getSeries_nonAdmin_withAccessibleLibrary_succeeds() {
      ...
      mockAggregateQuery(List.of(mockSeriesTuple("Dune", 6L, 6, Instant.now(), 2L)));
      mockCountQuery(1L);
    ...
    void getSeries_nonAdmin_noAccessToLibrary_throwsForbidden() {
      ...
      assertThrows(APIException.class, () -> service.getSeries(0, 20, null, null, 5L, null, false));
    }

    @Test
    void getSeries_withSearch_passesSearchPattern() {
      mockAdminUser();
      mockAggregateQuery(List.of(mockSeriesTuple("Harry Potter", 7L, 7, Instant.now(), 7L)));
      mockCountQuery(1L);
      mockBooksQuery(List.of(buildBook(3L, "Harry Potter", 1.0f, "J.K. Rowling")));

      AppPageResponse<AppSeriesSummary> result =
          service.getSeries(0, 20, null, null, null, "harry", false);
    ...
    void getSeries_inProgressOnly_returnsFilteredResults() {
      ...
      AppPageResponse<AppSeriesSummary> result =
          service.getSeries(0, 20, null, null, null, null, true);
    ...
    void getSeries_paginationDefaults_appliedCorrectly() {
      ...
      AppPageResponse<AppSeriesSummary> result =
          service.getSeries(null, null, null, null, null, null, false);
    ...
    void getSeries_pageSizeCapped_atMax() {
      ...
      AppPageResponse<AppSeriesSummary> result =
          service.getSeries(0, 100, null, null, null, null, false);
    ...
    void getSeries_enrichesCoverBooksAndAuthors() {
      ...
      mockAggregateQuery(List.of(mockSeriesTuple("Series X", 2L, 3, Instant.now(), 1L)));
      mockCountQuery(1L);
    ...
    void getSeries_sortByName_asc() {
      ...
      AppPageResponse<AppSeriesSummary> result =
          service.getSeries(0, 20, "name", "asc", null, null, false);
    ...
    void getSeries_sortByBookCount_desc() {
      ...
      AppPageResponse<AppSeriesSummary> result =
          service.getSeries(0, 20, "bookCount", "desc", null, null, false);
  ...
  class GetSeriesBooksTests {
    ...
    void getSeriesBooks_admin_returnsBooks() {
      ...
      AppPageResponse<AppBookSummary> result =
          service.getSeriesBooks("Dune", 0, 20, null, null, null);
    ...
    void getSeriesBooks_nonAdmin_noAccess_throwsForbidden() {
      ...
      assertThrows(APIException.class, () -> service.getSeriesBooks("Dune", 0, 20, null, null, 5L));
    }
    ...
    void getSeriesBooks_emptyResult_returnsEmptyPage() {
      ...
      AppPageResponse<AppBookSummary> result =
          service.getSeriesBooks("Nonexistent", 0, 20, null, null, null);
    ...
    void getSeriesBooks_sortByTitle_desc() {
      ...
      AppPageResponse<AppBookSummary> result =
          service.getSeriesBooks("Dune", 0, 20, "title", "desc", null);
    ...
    void getSeriesBooks_sortByRecentlyAdded_asc() {
      ...
      AppPageResponse<AppBookSummary> result =
          service.getSeriesBooks("Dune", 0, 20, "recentlyAdded", "asc", null);
    ...
    void getSeriesBooks_paginationDefaults() {
      ...
      AppPageResponse<AppBookSummary> result =
          service.getSeriesBooks("Dune", null, null, null, null, null);
    ...
    void getSeriesBooks_pageSizeCapped() {
      ...
      AppPageResponse<AppBookSummary> result =
          service.getSeriesBooks("Dune", 0, 200, null, null, null);
  ...
  private Tuple mockSeriesTuple(
      String name, Long count, Integer total, Instant addedOn, Long booksRead) {
  ...
  private Tuple mockSeriesTupleInProgress(
      String name,
      Long count,
      Integer total,
      Instant addedOn,
  ...
  private void mockAggregateQueryInProgress(List<Tuple> results) {
    // Pre-compute series names before setting up mocks to avoid calling .get() on mock Tuples
    // during stubbing
  ...
  private BookEntity buildBook(Long id, String seriesName, Float seriesNumber, String authorName) {
    ...
    BookFileEntity bookFile = BookFileEntity.builder().id(id).bookType(BookFileType.EPUB).build();

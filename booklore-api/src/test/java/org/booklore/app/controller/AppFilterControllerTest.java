...
class AppFilterControllerTest {
  ...
  @Mock private AppBookService mobileBookService;

  @InjectMocks private AppFilterController controller;
  ...
  private AppFilterOptions buildOptions(
      List<String> authorNames, List<String> fileTypes, List<String> langCodes) {

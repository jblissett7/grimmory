...
class BookNotesV2ControllerTest {
  ...
  @Mock private BookNoteV2Service bookNoteV2Service;

  @InjectMocks private BookNotesV2Controller controller;
  ...
  void updateNote_updatesPartialFields() {
    UpdateBookNoteV2Request request =
        UpdateBookNoteV2Request.builder().noteContent("Updated content only").build();
  ...
  void getNotesForBook_delegatesToService() {
    List<BookNoteV2> notes =
        List.of(createSampleNote(1L), createSampleNote(2L), createSampleNote(3L));

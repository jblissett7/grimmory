...
class BookMetadataEntityTest {
  ...
  void updateSearchText_handlesFrenchGermanAndSpanishDiacritics() {
    ...
    assertTrue(
        searchText.contains("a la francaise"), "Should contain 'a la francaise': " + searchText);
    ...
    assertTrue(
        searchText.contains("francois muller"), "Should contain 'francois muller': " + searchText);
  ...
  void searchSimulation_withDiacritics() {
    ...
    assertTrue(
        storedSearchText.contains(searchQuery1),
        "Search 'nesbo' should match stored text: " + storedSearchText);
    assertTrue(
        storedSearchText.contains(searchQuery2),
        "Search 'Nesbø' should match stored text: " + storedSearchText);
    assertTrue(
        storedSearchText.contains(searchQuery3),
        "Search 'NESBO' should match stored text: " + storedSearchText);
    assertTrue(
        storedSearchText.contains(searchQuery4),

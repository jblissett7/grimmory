...
class BookMetadataBuilderTest {
  ...
  void builder_withNullCategories_doesNotThrow() {
    BookMetadata metadata = BookMetadata.builder().title("Test Book").categories(null).build();
  ...
  void builder_withValidCategories_setsCategories() {
    ...
    BookMetadata metadata = BookMetadata.builder().categories(categories).build();
  ...
  void builder_withNullAuthors_doesNotThrow() {
    BookMetadata metadata = BookMetadata.builder().authors(null).build();
  ...
  void builder_withNullMoods_doesNotThrow() {
    BookMetadata metadata = BookMetadata.builder().moods(null).build();
  ...
  void builder_withNullTags_doesNotThrow() {
    BookMetadata metadata = BookMetadata.builder().tags(null).build();
  ...
  void builder_minimalMetadata_simulatesPhysicalBookCreation() {
    BookMetadata metadata = BookMetadata.builder().title("My Physical Book").build();

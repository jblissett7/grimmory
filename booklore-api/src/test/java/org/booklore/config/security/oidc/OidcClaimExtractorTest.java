...
class OidcClaimExtractorTest {
  ...
  void extractClaims_fallsBackToUserInfo_whenIdTokenClaimsMissing() {
    ...
    JWTClaimsSet claims = new JWTClaimsSet.Builder().subject("sub-789").build();
  ...
  void extractClaims_fallsBackToUserInfoFallbackClaims() {
    JWTClaimsSet claims = new JWTClaimsSet.Builder().subject("sub-abc").build();
  ...
  void extractClaims_usernameFallsBackToEmail_whenUsernameIsNull() {
    JWTClaimsSet claims =
        new JWTClaimsSet.Builder().subject("sub-def").claim("email", "eve@example.com").build();
  ...
  void extractClaims_usernameFallsBackToSubject_whenBothUsernameAndEmailNull() {
    JWTClaimsSet claims = new JWTClaimsSet.Builder().subject("sub-ghi").build();
  ...
  void extractClaims_usernameFallsBackToSubject_whenUsernameIsBlank() {
    JWTClaimsSet claims =
        new JWTClaimsSet.Builder().subject("sub-jkl").claim("preferred_username", "   ").build();
  ...
  void extractClaims_groupsFallBackToUserInfo() {
    ...
    JWTClaimsSet claims =
        new JWTClaimsSet.Builder().subject("sub-pqr").claim("preferred_username", "grace").build();

    Map<String, Object> userInfo = Map.of("roles", List.of("contributor"));
  ...
  void extractClaims_groupsReturnEmptyList_whenNothingFound() {
    JWTClaimsSet claims =
        new JWTClaimsSet.Builder().subject("sub-stu").claim("preferred_username", "hank").build();
  ...
  void extractClaims_pictureUrlExtractedFromUserInfoFallback() {
    JWTClaimsSet claims =
        new JWTClaimsSet.Builder().subject("sub-vwx").claim("preferred_username", "iris").build();

    Map<String, Object> userInfo = Map.of("picture", "https://example.com/avatar.jpg");

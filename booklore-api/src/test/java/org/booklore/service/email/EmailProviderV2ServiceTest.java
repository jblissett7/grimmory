...
class EmailProviderV2ServiceTest {
  ...
  @Mock private EmailProviderV2Repository repository;

  @Mock private UserEmailProviderPreferenceRepository preferenceRepository;

  @Mock private EmailProviderV2Mapper mapper;

  @Mock private AuthenticationService authService;

  @Mock private AuditService auditService;

  @InjectMocks private EmailProviderV2Service emailProviderV2Service;
  ...
  void setUp() {
    ...
    savedEntity =
        EmailProviderV2Entity.builder().id(10L).userId(1L).host("smtp.test.com").port(587).build();

    providerDto =
        EmailProviderV2.builder()
            .id(10L)
            .userId(1L)
            .host("smtp.test.com")
            .port(587)
  ...
  void createEmailProvider_nullShared_setsSharedFalse() {
    CreateEmailProviderRequest request =
        CreateEmailProviderRequest.builder()
            .name("Test")
            .host("smtp.test.com")
            .port(587)
            .shared(null)
  ...
  void updateEmailProvider_nullShared_adminSetsSharedFalse() {
    ...
    EmailProviderV2Entity existingEntity =

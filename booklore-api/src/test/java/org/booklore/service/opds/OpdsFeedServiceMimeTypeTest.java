...
class OpdsFeedServiceMimeTypeTest {
  ...
  void testMimeTypeFromCachedArchiveType() {
    Book book =
        createBookWithArchiveType(BookFileType.CBX, "whatever.cbz", ArchiveUtils.ArchiveType.RAR);
  ...
  private Book createBookWithArchiveType(
      BookFileType type, String fileName, ArchiveUtils.ArchiveType archiveType) {

...
class BookRuleEvaluatorNumericFieldsTest {
  ...
  class StringValueAsNumberTests {
    ...
    void lessThan_withStringValue_parsesCorrectly() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_SCORE, RuleOperator.LESS_THAN, "50"));
    ...
    void greaterThan_withStringValue_parsesCorrectly() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_SCORE, RuleOperator.GREATER_THAN, "50"));
    ...
    void greaterThanEqual_withStringValue_parsesCorrectly() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_SCORE, RuleOperator.GREATER_THAN_EQUAL_TO, "50"));
    ...
    void lessThanEqual_withStringValue_parsesCorrectly() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_SCORE, RuleOperator.LESS_THAN_EQUAL_TO, "50"));
      assertThat(ids).contains(exact.getId());
    ...
    void inBetween_withStringValues_parsesCorrectly() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_SCORE, RuleOperator.IN_BETWEEN, null, "40", "70"));
    ...
    void pageCount_greaterThan_withStringValue() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.PAGE_COUNT, RuleOperator.GREATER_THAN, "300"));
    ...
    void nonNumericStringValue_returnsAllBooks() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_SCORE, RuleOperator.GREATER_THAN, "not_a_number"));
  ...
  class MetadataScoreTests {
    ...
    void equals_matchesExactScore() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_SCORE, RuleOperator.EQUALS, 75));
      assertThat(ids).contains(exact.getId());
    ...
    void inBetween_matchesScoreInRange() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_SCORE, RuleOperator.IN_BETWEEN, null, 40, 80));
      assertThat(ids).contains(inRange.getId());
    ...
    void nullScore_doesNotMatchComparison() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_SCORE, RuleOperator.GREATER_THAN, 0));
  ...
  class RatingFieldTests {
    ...
    void amazonRating_greaterThan() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.AMAZON_RATING, RuleOperator.GREATER_THAN, 3.5));
    ...
    void goodreadsRating_lessThanEqual() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.GOODREADS_RATING, RuleOperator.LESS_THAN_EQUAL_TO, 3.0));
    ...
    void hardcoverRating_inBetween() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.HARDCOVER_RATING, RuleOperator.IN_BETWEEN, null, 3.0, 4.0));
    ...
    void amazonReviewCount_greaterThan() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.AMAZON_REVIEW_COUNT, RuleOperator.GREATER_THAN, 1000));
    ...
    void goodreadsReviewCount_lessThan() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.GOODREADS_REVIEW_COUNT, RuleOperator.LESS_THAN, 100));
    ...
    void audibleRating_greaterThanWithStringValue() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.AUDIBLE_RATING, RuleOperator.GREATER_THAN, "4.0"));
    ...
    void lubimyczytacRating_equals() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.LUBIMYCZYTAC_RATING, RuleOperator.EQUALS, 4.0));
      assertThat(ids).contains(rated.getId());
      assertThat(ids).doesNotContain(other.getId());
    }
    ...
    void ranobedbRating_lessThan() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.RANOBEDB_RATING, RuleOperator.LESS_THAN, 3.0));
      assertThat(ids).contains(low.getId());
      assertThat(ids).doesNotContain(high.getId());
    }
  }
  ...
  class PersonalRatingTests {
    ...
    void greaterThan_matchesHighRating() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.PERSONAL_RATING, RuleOperator.GREATER_THAN, 3));
      assertThat(ids).contains(highRated.getId());
      assertThat(ids).doesNotContain(lowRated.getId());
    }
    ...
    void equals_matchesExactRating() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.PERSONAL_RATING, RuleOperator.EQUALS, 4));
    ...
    void inBetween_matchesRatingInRange() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.PERSONAL_RATING, RuleOperator.IN_BETWEEN, null, 2, 4));
      assertThat(ids).contains(rated3.getId());
  ...
  class AgeRatingTests {
    ...
    void greaterThan_matchesMatureContent() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.AGE_RATING, RuleOperator.GREATER_THAN, 12));
    ...
    void lessThanEqual_matchesYoungAudience() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.AGE_RATING, RuleOperator.LESS_THAN_EQUAL_TO, 13));
  ...
  class PageCountComparisonTests {
    ...
    void greaterThanEqual_matchesBoundary() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.PAGE_COUNT, RuleOperator.GREATER_THAN_EQUAL_TO, 300));
      assertThat(ids).contains(exact.getId());
      assertThat(ids).doesNotContain(below.getId());
    }
    ...
    void lessThanEqual_matchesBoundary() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.PAGE_COUNT, RuleOperator.LESS_THAN_EQUAL_TO, 200));
      assertThat(ids).contains(exact.getId());
      assertThat(ids).doesNotContain(above.getId());
    }
    ...
    void inBetween_matchesPageRange() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.PAGE_COUNT, RuleOperator.IN_BETWEEN, null, 100, 500));
  ...
  class SeriesNumberTests {
    ...
    void greaterThan_matchesHighSeriesNumber() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_NUMBER, RuleOperator.GREATER_THAN, 3));
  ...
  class AudiobookDurationTests {
    ...
    void greaterThan_matchesLongAudiobook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.AUDIOBOOK_DURATION, RuleOperator.GREATER_THAN, 7200));
      assertThat(ids).contains(longBook.getId());
      assertThat(ids).doesNotContain(shortBook.getId());
    }
    ...
    void lessThan_matchesShortAudiobook() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.AUDIOBOOK_DURATION, RuleOperator.LESS_THAN, 3600));
    ...
    void inBetween_matchesMidLengthAudiobook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.AUDIOBOOK_DURATION, RuleOperator.IN_BETWEEN, null, 3600, 36000));
  ...
  class HardcoverReviewCountTests {
    ...
    void greaterThanEqual_matchesBoundary() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(
                  RuleField.HARDCOVER_REVIEW_COUNT, RuleOperator.GREATER_THAN_EQUAL_TO, 100));
      assertThat(ids).contains(exact.getId());
      assertThat(ids).doesNotContain(below.getId());
    }
  }
  ...
  class AudibleReviewCountTests {
    ...
    void lessThanEqual_matchesLowCount() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.AUDIBLE_REVIEW_COUNT, RuleOperator.LESS_THAN_EQUAL_TO, 50));
  ...
  class SeriesTotalTests {
    ...
    void greaterThan_matchesLongSeries() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_TOTAL, RuleOperator.GREATER_THAN, 10));

...
class DuplicateDetectionServiceTest {
  ...
  void setUp() {
    ...
    nextBookId = 1L;
    lenient()
        .when(bookMapper.toBook(any(BookEntity.class)))
        .thenAnswer(
            inv -> {
  ...
  private BookEntity createBook(BookFileType fileType, String title, String authorName) {
    ...
    BookMetadataEntity metadata =
        BookMetadataEntity.builder().bookId(id).title(title).authors(authors).build();
  ...
  private BookEntity createBookWithIsbn(
      BookFileType fileType, String title, String authorName, String isbn13, String isbn10) {
  ...
  class General {
    ...
    void returnsEmptyWhenNoSignalsEnabled() {
      BookEntity book1 =
          createBookWithIsbn(BookFileType.EPUB, "Same", "Author", "9781234567890", null);
      BookEntity book2 =
          createBookWithIsbn(BookFileType.MOBI, "Same", "Author", "9781234567890", null);
      stubBooks(book1, book2);

      DuplicateDetectionRequest noSignals =
          new DuplicateDetectionRequest(LIBRARY_ID, false, false, false, false, false);
  ...
  class IsbnMatching {
    ...
    void groupsBooksWithSameIsbn13() {
      BookEntity book1 =
          createBookWithIsbn(BookFileType.EPUB, "Book", "Author", "9781234567890", null);
      BookEntity book2 =
          createBookWithIsbn(BookFileType.MOBI, "Book", "Author", "9781234567890", null);
      stubBooks(book1, book2);
    ...
    void convertsIsbn10ToIsbn13ForMatching() {
      BookEntity book1 =
          createBookWithIsbn(BookFileType.EPUB, "Book", "Author", "9780306406157", null);
      BookEntity book2 =
          createBookWithIsbn(BookFileType.MOBI, "Book", "Author", null, "0306406152");
      stubBooks(book1, book2);
    ...
    void doesNotGroupDifferentIsbns() {
      BookEntity book1 =
          createBookWithIsbn(BookFileType.EPUB, "Book A", "Author", "9781234567890", null);
      BookEntity book2 =
          createBookWithIsbn(BookFileType.MOBI, "Book B", "Author", "9780987654321", null);
      stubBooks(book1, book2);
  ...
  class StrategyOrdering {
    ...
    void higherConfidenceStrategyPreventsLowerFromRegrouping() {
      BookEntity book1 =
          createBookWithIsbn(BookFileType.EPUB, "Same Title", "Same Author", "9781234567890", null);
      book1.getMetadata().setGoodreadsId("gr1");
      BookEntity book2 =
          createBookWithIsbn(BookFileType.MOBI, "Same Title", "Same Author", "9781234567890", null);
    ...
    void booksGroupedByIsbnNotRegroupedByTitleAuthor() {
      BookEntity book1 =
          createBookWithIsbn(BookFileType.EPUB, "The Book", "Author", "9781234567890", null);
      BookEntity book2 =
          createBookWithIsbn(BookFileType.MOBI, "The Book", "Author", "9781234567890", null);
      ...
      DuplicateGroup isbnGroup =
          result.stream().filter(g -> g.matchReason().equals("ISBN")).findFirst().orElseThrow();
      DuplicateGroup titleGroup =
          result.stream()
              .filter(g -> g.matchReason().equals("TITLE_AUTHOR"))
              .findFirst()
              .orElseThrow();
    ...
    void multipleStrategiesCreateSeparateGroups() {
      BookEntity book1 =
          createBookWithIsbn(BookFileType.EPUB, "Book A", "Author A", "9781234567890", null);
      BookEntity book2 =
          createBookWithIsbn(BookFileType.MOBI, "Book A", "Author A", "9781234567890", null);
  ...
  class EdgeCases {
    ...
    void singletonGroupsAreFiltered() {
      BookEntity book1 =
          createBookWithIsbn(BookFileType.EPUB, "Unique A", "Author", "9781111111111", null);
      BookEntity book2 =
          createBookWithIsbn(BookFileType.MOBI, "Unique B", "Author", "9782222222222", null);
      stubBooks(book1, book2);
    ...
    void handlesLargeGroupCorrectly() {
      ...
      for (int i = 0; i < 10; i++) {
        BookEntity book =
            createBookWithIsbn(BookFileType.EPUB, "Popular Book", "Author", "9781234567890", null);
        books.add(book);
      }

...
class KoboLibrarySyncServiceTest {
  ...
  @Mock private BookloreSyncTokenGenerator tokenGenerator;
  @Mock private KoboLibrarySnapshotService koboLibrarySnapshotService;
  @Mock private KoboEntitlementService entitlementService;
  ...
  @InjectMocks private KoboLibrarySyncService service;
  ...
  class WebReaderProgressSync {
    ...
    @Test
    @DisplayName(
        "Should detect web reader progress needing sync when toggle ON and lastReadTime after sent")

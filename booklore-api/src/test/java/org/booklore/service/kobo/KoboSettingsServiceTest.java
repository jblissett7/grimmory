...
class KoboSettingsServiceTest {
  ...
  @Mock private KoboUserSettingsRepository repository;
  @Mock private AuthenticationService authenticationService;
  @Mock private ShelfService shelfService;
  @Mock private HardcoverSyncSettingsService hardcoverSyncSettingsService;

  @InjectMocks private KoboSettingsService service;
  ...
  void getCurrentUserSettings_existingSettings() {
    ...
    assertEquals(
        settingsEntity.getProgressMarkAsReadingThreshold(),
        dto.getProgressMarkAsReadingThreshold());
    assertEquals(
        settingsEntity.getProgressMarkAsFinishedThreshold(),
        dto.getProgressMarkAsFinishedThreshold());
  }
  ...
  void getCurrentUserSettings_noSettings_createsDefault() {
    ...
    doReturn(Shelf.builder().id(100L).build())
        .when(shelfService)
        .createShelf(any(ShelfCreateRequest.class));

...
class BookRuleEvaluatorServiceIntegrationTest {
  ...
  @Autowired private BookRuleEvaluatorService evaluator;
  ...
  private BookEntity createBook(
      String title, String seriesName, Float seriesNumber, Integer seriesTotal) {
    BookEntity book =
        BookEntity.builder()
            .library(library)
  ...
  private UserBookProgressEntity createProgress(
      BookEntity book, ReadStatus status, Float koreaderPercent, Instant dateFinished) {
  ...
  private GroupRule singleRule(
      RuleField field, RuleOperator operator, Object value, Object valueStart, Object valueEnd) {
    Rule rule = new Rule();
    rule.setField(field);
  ...
  class ReadingProgressTests {
    ...
    void greaterThan_matchesBookWithHighProgress() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.READING_PROGRESS, RuleOperator.GREATER_THAN, 50));
    ...
    void lessThan_matchesBookWithLowProgress() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.READING_PROGRESS, RuleOperator.LESS_THAN, 50));
      assertThat(ids).contains(book.getId());
  ...
  class RelativeDateTests {
    ...
    void withinLast_matchesRecentBook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.ADDED_ON, RuleOperator.WITHIN_LAST, 7, null, "days"));
    ...
    void olderThan_matchesOldBook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.ADDED_ON, RuleOperator.OLDER_THAN, 30, null, "days"));
    ...
    void thisPeriod_year_matchesThisYearBook() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.ADDED_ON, RuleOperator.THIS_PERIOD, "year"));
    ...
    void withinLast_months_matchesRecentBook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.ADDED_ON, RuleOperator.WITHIN_LAST, 3, null, "months"));
      assertThat(ids).contains(recent.getId());
      assertThat(ids).doesNotContain(old.getId());
    }
  }
  ...
  class SeriesStatusTests {
    ...
    void fullyRead_matchesSeriesWhereAllBooksRead() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_STATUS, RuleOperator.EQUALS, "fully_read"));
    ...
    void notStarted_matchesSeriesWithNoProgress() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_STATUS, RuleOperator.EQUALS, "not_started"));
    ...
    void reading_matchesSeriesWithActiveReading() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_STATUS, RuleOperator.EQUALS, "reading"));
      assertThat(ids).contains(b1.getId(), b2.getId());
    }
    ...
    void completed_matchesSeriesOwningLastBook() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_STATUS, RuleOperator.EQUALS, "completed"));
  ...
  class SeriesGapsTests {
    ...
    void anyGap_matchesSeriesWithMissingNumbers() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_GAPS, RuleOperator.EQUALS, "any_gap"));
    ...
    void missingFirst_matchesSeriesWithoutBookOne() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_GAPS, RuleOperator.EQUALS, "missing_first"));
    ...
    void duplicateNumber_matchesSeriesWithDuplicates() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.SERIES_GAPS, RuleOperator.EQUALS, "duplicate_number"));
  ...
  class SeriesPositionTests {
    ...
    void firstInSeries_matchesLowestNumberedBook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.SERIES_POSITION, RuleOperator.EQUALS, "first_in_series"));
    ...
    void lastInSeries_matchesHighestNumberedBook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.SERIES_POSITION, RuleOperator.EQUALS, "last_in_series"));
    ...
    void nextUnread_matchesFirstUnreadAfterReadBook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.SERIES_POSITION, RuleOperator.EQUALS, "next_unread"));
  ...
  class NegationTests {
    ...
    void seriesStatus_notEquals_excludesMatching() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.SERIES_STATUS, RuleOperator.NOT_EQUALS, "fully_read"));
      assertThat(ids).contains(u1.getId(), u2.getId());
      assertThat(ids).doesNotContain(b1.getId(), b2.getId());
    }
  }
  ...
  class ReadingProgressEdgeCases {
    ...
    void inBetween_matchesBooksInRange() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.READING_PROGRESS, RuleOperator.IN_BETWEEN, null, 30, 70));
    ...
    void equals_matchesExactProgress() {
      ...
      List<Long> matchIds =
          findMatchingIds(singleRule(RuleField.READING_PROGRESS, RuleOperator.EQUALS, 50));
      assertThat(matchIds).contains(book.getId());

      List<Long> noMatchIds =
          findMatchingIds(singleRule(RuleField.READING_PROGRESS, RuleOperator.EQUALS, 60));
    ...
    void greaterThanEqualTo_matchesBoundary() {
      ...
      List<Long> matchIds =
          findMatchingIds(
              singleRule(RuleField.READING_PROGRESS, RuleOperator.GREATER_THAN_EQUAL_TO, 50));
      assertThat(matchIds).contains(book.getId());

      List<Long> noMatchIds =
          findMatchingIds(
              singleRule(RuleField.READING_PROGRESS, RuleOperator.GREATER_THAN_EQUAL_TO, 51));
      assertThat(noMatchIds).doesNotContain(book.getId());
    }
    ...
    void lessThanEqualTo_matchesBoundary() {
      ...
      List<Long> matchIds =
          findMatchingIds(
              singleRule(RuleField.READING_PROGRESS, RuleOperator.LESS_THAN_EQUAL_TO, 50));
      assertThat(matchIds).contains(book.getId());

      List<Long> noMatchIds =
          findMatchingIds(
              singleRule(RuleField.READING_PROGRESS, RuleOperator.LESS_THAN_EQUAL_TO, 49));
      assertThat(noMatchIds).doesNotContain(book.getId());
    }
    ...
    void noProgressRecord_treatedAsZero() {
      ...
      List<Long> zeroIds =
          findMatchingIds(singleRule(RuleField.READING_PROGRESS, RuleOperator.EQUALS, 0));
      assertThat(zeroIds).contains(book.getId());

      List<Long> gtIds =
          findMatchingIds(singleRule(RuleField.READING_PROGRESS, RuleOperator.GREATER_THAN, 0));
  ...
  class RelativeDateEdgeCases {
    ...
    void withinLast_weeks_matchesRecentBook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.ADDED_ON, RuleOperator.WITHIN_LAST, 2, null, "weeks"));
      assertThat(ids).contains(recent.getId());
      assertThat(ids).doesNotContain(old.getId());
    }
    ...
    void withinLast_years_matchesRecentBook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.ADDED_ON, RuleOperator.WITHIN_LAST, 1, null, "years"));
      assertThat(ids).contains(recent.getId());
      assertThat(ids).doesNotContain(old.getId());
    }
    ...
    void olderThan_months_matchesOldBook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.ADDED_ON, RuleOperator.OLDER_THAN, 3, null, "months"));
      assertThat(ids).contains(old.getId());
      assertThat(ids).doesNotContain(recent.getId());
    }
    ...
    void olderThan_years_matchesOldBook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.ADDED_ON, RuleOperator.OLDER_THAN, 1, null, "years"));
      assertThat(ids).contains(old.getId());
      assertThat(ids).doesNotContain(recent.getId());
    }
    ...
    void thisPeriod_month_matchesThisMonthBook() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.ADDED_ON, RuleOperator.THIS_PERIOD, "month"));
    ...
    void dateFinished_withinLast_matchesRecentlyFinished() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.DATE_FINISHED, RuleOperator.WITHIN_LAST, 7, null, "days"));
      assertThat(ids).contains(book.getId());
    }
    ...
    void dateFinished_olderThan_matchesOldFinish() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.DATE_FINISHED, RuleOperator.OLDER_THAN, 30, null, "days"));
      assertThat(ids).contains(book.getId());
    }
    ...
    void publishedDate_withinLast_matchesRecentlyPublished() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.PUBLISHED_DATE, RuleOperator.WITHIN_LAST, 30, null, "days"));
      assertThat(ids).contains(book.getId());
    }
    ...
    void nullValue_returnsAllBooks() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.ADDED_ON, RuleOperator.WITHIN_LAST, null, null, "days"));
      assertThat(ids).contains(book.getId());
    }
  }
  ...
  class SeriesStatusEdgeCases {
    ...
    void ongoing_matchesSeriesWithTotalButMissingLast() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_STATUS, RuleOperator.EQUALS, "ongoing"));
  ...
  class SeriesGapsEdgeCases {
    ...
    void missingLatest_matchesSeriesMissingLastBook() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_GAPS, RuleOperator.EQUALS, "missing_latest"));
  ...
  class StringOperatorTests {
    ...
    void contains_matchesTitleSubstring() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.TITLE, RuleOperator.CONTAINS, "potter"));
    ...
    void doesNotContain_excludesTitleSubstring() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.TITLE, RuleOperator.DOES_NOT_CONTAIN, "potter"));
    ...
    void startsWith_matchesTitlePrefix() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.TITLE, RuleOperator.STARTS_WITH, "harry"));
      assertThat(ids).contains(hp.getId());
    ...
    void endsWith_matchesTitleSuffix() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.TITLE, RuleOperator.ENDS_WITH, "hobbit"));
    ...
    void contains_onArrayField_matchesAuthorName() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.AUTHORS, RuleOperator.CONTAINS, "sanderson"));
  ...
  class EmptyOperatorTests {
    ...
    void isEmpty_matchesBookWithNullPublisher() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.PUBLISHER, RuleOperator.IS_EMPTY, null));
    ...
    void isNotEmpty_matchesBookWithPublisher() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.PUBLISHER, RuleOperator.IS_NOT_EMPTY, null));
    ...
    void isNotEmpty_onArrayField_matchesBookWithAuthors() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.AUTHORS, RuleOperator.IS_NOT_EMPTY, null));
  ...
  class MultiValueOperatorTests {
    ...
    void includesAny_matchesReadStatusInList() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(
                  RuleField.READ_STATUS, RuleOperator.INCLUDES_ANY, List.of("READ", "READING")));
    ...
    void excludesAll_excludesReadStatusInList() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(
                  RuleField.READ_STATUS, RuleOperator.EXCLUDES_ALL, List.of("READ", "READING")));
    ...
    void includesAny_onArrayField_matchesAnyAuthor() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(
                  RuleField.AUTHORS, RuleOperator.INCLUDES_ANY, List.of("Author A", "Author B")));
    ...
    void excludesAll_onArrayField_excludesAllAuthors() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(
                  RuleField.AUTHORS, RuleOperator.EXCLUDES_ALL, List.of("Author A2", "Author B2")));
    ...
    void includesAll_onArrayField_matchesBookWithAllAuthors() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(
                  RuleField.AUTHORS, RuleOperator.INCLUDES_ALL, List.of("Author X", "Author Y")));
  ...
  class EqualsEdgeCaseTests {
    ...
    void equals_stringField_caseInsensitive() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.TITLE, RuleOperator.EQUALS, "harry potter"));
      assertThat(ids).contains(hp.getId());
    }
    ...
    void equals_booleanField_matchesTrue() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.IS_PHYSICAL, RuleOperator.EQUALS, "true"));
    ...
    void equals_booleanField_matchesFalse() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.IS_PHYSICAL, RuleOperator.EQUALS, "false"));
    ...
    void notEquals_stringField_excludesMatch() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.TITLE, RuleOperator.NOT_EQUALS, "harry potter"));
      assertThat(ids).contains(hobbit.getId());
      assertThat(ids).doesNotContain(hp.getId());
    }
    ...
    void equals_readStatus_matchesSpecificStatus() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.READ_STATUS, RuleOperator.EQUALS, "READ"));
    ...
    void equals_readStatus_unset_matchesNullProgress() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.READ_STATUS, RuleOperator.EQUALS, "UNSET"));
  ...
  class DateComparisonTests {
    ...
    void greaterThan_matchesPublishedDateAfterThreshold() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.PUBLISHED_DATE, RuleOperator.GREATER_THAN, "2023-01-01"));
    ...
    void lessThan_matchesPublishedDateBeforeThreshold() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.PUBLISHED_DATE, RuleOperator.LESS_THAN, "2023-01-01"));
    ...
    void inBetween_matchesPublishedDateInRange() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(
                  RuleField.PUBLISHED_DATE,
                  RuleOperator.IN_BETWEEN,
                  null,
                  "2023-01-01",
                  "2024-01-01"));
  ...
  class ReadStatusUnsetTests {
    ...
    void includesAny_withUnsetAndOtherStatuses() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(
                  RuleField.READ_STATUS, RuleOperator.INCLUDES_ANY, List.of("UNSET", "READ")));
    ...
    void includesAny_withOnlyUnset() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.READ_STATUS, RuleOperator.INCLUDES_ANY, List.of("UNSET")));
      assertThat(ids).contains(noProgress.getId());
  ...
  class CompositeNegationTests {
    ...
    void seriesGaps_notEquals_excludesMatching() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_GAPS, RuleOperator.NOT_EQUALS, "any_gap"));
    ...
    void seriesPosition_notEquals_excludesMatching() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.SERIES_POSITION, RuleOperator.NOT_EQUALS, "first_in_series"));
  ...
  class PublishedDateRelativeTests {
    ...
    void olderThan_publishedDate_matchesOldBook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.PUBLISHED_DATE, RuleOperator.OLDER_THAN, 3, null, "months"));
      assertThat(ids).contains(oldBook.getId());
      assertThat(ids).doesNotContain(recentBook.getId());
    }
    ...
    void thisPeriod_publishedDate_matchesThisYearBook() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.PUBLISHED_DATE, RuleOperator.THIS_PERIOD, "year"));
      assertThat(ids).contains(recentBook.getId());
      assertThat(ids).doesNotContain(oldBook.getId());
    }
    ...
    void thisPeriod_week_matchesThisWeekBook() {
      ...
      LocalDate thisWeekWednesday =
          LocalDate.now()
              .with(java.time.temporal.TemporalAdjusters.previousOrSame(java.time.DayOfWeek.MONDAY))
              .plusDays(2);
      // If Wednesday is in the future (we're Mon/Tue), just use today
      LocalDate safeDate =
          thisWeekWednesday.isAfter(LocalDate.now()) ? LocalDate.now() : thisWeekWednesday;
      Instant thisWeekInstant =
          safeDate
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.ADDED_ON, RuleOperator.THIS_PERIOD, "week"));
  ...
  class MetadataPresenceTests {
    ...
    void has_stringField_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "description"));
    ...
    void hasNot_stringField_matchesWhenAbsent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.NOT_EQUALS, "description"));
    ...
    void has_numericField_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "pageCount"));
    ...
    void has_isbn13_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "isbn13"));
    ...
    void has_coverImage_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "thumbnailUrl"));
    ...
    void has_authors_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "authors"));
      assertThat(ids).contains(withAuthors.getId());
      assertThat(ids).doesNotContain(noAuthors.getId());
    }
    ...
    void hasNot_authors_matchesWhenAbsent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.NOT_EQUALS, "authors"));
      assertThat(ids).contains(noAuthors.getId());
      assertThat(ids).doesNotContain(withAuthors.getId());
    }
    ...
    void has_categories_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "categories"));
    ...
    void has_rating_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "amazonRating"));
    ...
    void has_externalId_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "goodreadsId"));
    ...
    void has_personalRating_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "personalRating"));
      assertThat(ids).contains(withRating.getId());
      assertThat(ids).doesNotContain(noRating.getId());
    }
    ...
    void has_publishedDate_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "publishedDate"));
    ...
    void has_seriesInfo_matchesWhenPresent() {
      ...
      List<Long> idsName =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "seriesName"));
      assertThat(idsName).contains(withSeries.getId());
      assertThat(idsName).doesNotContain(noSeries.getId());

      List<Long> idsNumber =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "seriesNumber"));
      assertThat(idsNumber).contains(withSeries.getId());
      assertThat(idsNumber).doesNotContain(noSeries.getId());

      List<Long> idsTotal =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "seriesTotal"));
    ...
    void has_narrator_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "narrator"));
    ...
    void unknownField_matchesAll() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "nonExistentField"));
      assertThat(ids).contains(book.getId());
    }
    ...
    void has_moods_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "moods"));
    ...
    void has_tags_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "tags"));
    ...
    void has_booleanField_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "abridged"));
    ...
    void has_ageRating_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "ageRating"));
    ...
    void has_audiobookDuration_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "audiobookDuration"));
    ...
    void hasNot_audiobookDuration_matchesWhenAbsent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(
                  RuleField.METADATA_PRESENCE, RuleOperator.NOT_EQUALS, "audiobookDuration"));
    ...
    void has_comicCharacters_matchesWhenPresent() {
      ...
      ComicMetadataEntity comicMeta =
          ComicMetadataEntity.builder()
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "comicCharacters"));
    ...
    void has_comicTeams_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "comicTeams"));
      assertThat(ids).contains(comicBook.getId());
    ...
    void has_comicLocations_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "comicLocations"));
      assertThat(ids).contains(comicBook.getId());
    ...
    void has_comicPencillers_matchesWhenPresent() {
      ...
      em.persist(creator);
      ComicCreatorMappingEntity mapping =
          ComicCreatorMappingEntity.builder()
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "comicPencillers"));
      assertThat(ids).contains(comicBook.getId());
    ...
    void has_comicCreator_onlyMatchesCorrectRole() {
      ...
      List<Long> coloristIds =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "comicColorists"));
      assertThat(coloristIds).contains(comicBook.getId());

      // Has penciller → should NOT match (only colorist assigned)
      List<Long> pencillerIds =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "comicPencillers"));
      ...
      List<Long> inkerIds =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "comicInkers"));
    ...
    void hasNot_coverImage_matchesWhenAbsent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.NOT_EQUALS, "thumbnailUrl"));
    ...
    void hasNot_numericField_matchesWhenAbsent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.NOT_EQUALS, "pageCount"));
    ...
    void hasNot_unknownField_matchesNothing() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.NOT_EQUALS, "nonExistentField"));
    ...
    void has_nullValue_matchesAll() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, null));
      assertThat(ids).contains(book.getId());
    }
    ...
    void has_subtitle_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "subtitle"));
    ...
    void has_publisher_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "publisher"));
      assertThat(ids).contains(withPublisher.getId());
      assertThat(ids).doesNotContain(noPublisher.getId());
    }
    ...
    void has_language_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "language"));
    ...
    void has_asin_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "asin"));
    ...
    void has_contentRating_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "contentRating"));
    ...
    void has_isbn10_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "isbn10"));
    ...
    void has_reviewCount_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "audibleReviewCount"));
    ...
    void has_otherExternalIds_matchWhenPresent() {
      ...
      for (String field :
          List.of(
              ...
              "ranobedbId")) {
        List<Long> ids =
            findMatchingIds(singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, field));
    ...
    void has_otherReviewCounts_matchWhenPresent() {
      ...
      for (String field :
          List.of("amazonReviewCount", "goodreadsReviewCount", "hardcoverReviewCount")) {
        List<Long> ids =
            findMatchingIds(singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, field));
    ...
    void has_comicEditors_matchesWhenPresent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.EQUALS, "comicEditors"));
      assertThat(ids).contains(comicBook.getId());
    ...
    void hasNot_comicCharacters_matchesWhenAbsent() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.METADATA_PRESENCE, RuleOperator.NOT_EQUALS, "comicCharacters"));
  ...
  class IntegerFieldTests {
    ...
    void notEquals_integerField_excludesMatch() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.PAGE_COUNT, RuleOperator.NOT_EQUALS, 300));

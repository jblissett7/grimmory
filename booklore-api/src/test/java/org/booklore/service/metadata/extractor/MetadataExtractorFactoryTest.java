...
class MetadataExtractorFactoryTest {
  ...
  class ExtractMetadataByBookFileType {
    ...
    void routesToAudiobook() {
      ...
      assertThat(factory.extractMetadata(BookFileType.AUDIOBOOK, dummyFile))
          .isEqualTo(dummyMetadata);
    }
  ...
  class ExtractMetadataByBookFileExtension {
    ...
    void routesPdf() {
      when(pdfMetadataExtractor.extractMetadata(dummyFile)).thenReturn(dummyMetadata);
      assertThat(factory.extractMetadata(BookFileExtension.PDF, dummyFile))
          .isEqualTo(dummyMetadata);
    }
    ...
    void routesEpub() {
      when(epubMetadataExtractor.extractMetadata(dummyFile)).thenReturn(dummyMetadata);
      assertThat(factory.extractMetadata(BookFileExtension.EPUB, dummyFile))
          .isEqualTo(dummyMetadata);
    }
    ...
    void routesCbz() {
      when(cbxMetadataExtractor.extractMetadata(dummyFile)).thenReturn(dummyMetadata);
      assertThat(factory.extractMetadata(BookFileExtension.CBZ, dummyFile))
          .isEqualTo(dummyMetadata);
    }
    ...
    void routesCbr() {
      when(cbxMetadataExtractor.extractMetadata(dummyFile)).thenReturn(dummyMetadata);
      assertThat(factory.extractMetadata(BookFileExtension.CBR, dummyFile))
          .isEqualTo(dummyMetadata);
    }
    ...
    void routesCb7() {
      when(cbxMetadataExtractor.extractMetadata(dummyFile)).thenReturn(dummyMetadata);
      assertThat(factory.extractMetadata(BookFileExtension.CB7, dummyFile))
          .isEqualTo(dummyMetadata);
    }
    ...
    void routesFb2() {
      when(fb2MetadataExtractor.extractMetadata(dummyFile)).thenReturn(dummyMetadata);
      assertThat(factory.extractMetadata(BookFileExtension.FB2, dummyFile))
          .isEqualTo(dummyMetadata);
    }
    ...
    void routesMobi() {
      when(mobiMetadataExtractor.extractMetadata(dummyFile)).thenReturn(dummyMetadata);
      assertThat(factory.extractMetadata(BookFileExtension.MOBI, dummyFile))
          .isEqualTo(dummyMetadata);
    }
    ...
    void routesAzw3() {
      when(azw3MetadataExtractor.extractMetadata(dummyFile)).thenReturn(dummyMetadata);
      assertThat(factory.extractMetadata(BookFileExtension.AZW3, dummyFile))
          .isEqualTo(dummyMetadata);
    }
    ...
    void routesAzw() {
      when(azw3MetadataExtractor.extractMetadata(dummyFile)).thenReturn(dummyMetadata);
      assertThat(factory.extractMetadata(BookFileExtension.AZW, dummyFile))
          .isEqualTo(dummyMetadata);
    }
    ...
    void routesM4b() {
      when(audiobookMetadataExtractor.extractMetadata(dummyFile)).thenReturn(dummyMetadata);
      assertThat(factory.extractMetadata(BookFileExtension.M4B, dummyFile))
          .isEqualTo(dummyMetadata);
    }
    ...
    void routesM4a() {
      when(audiobookMetadataExtractor.extractMetadata(dummyFile)).thenReturn(dummyMetadata);
      assertThat(factory.extractMetadata(BookFileExtension.M4A, dummyFile))
          .isEqualTo(dummyMetadata);
    }
    ...
    void routesMp3() {
      when(audiobookMetadataExtractor.extractMetadata(dummyFile)).thenReturn(dummyMetadata);
      assertThat(factory.extractMetadata(BookFileExtension.MP3, dummyFile))
          .isEqualTo(dummyMetadata);
    }

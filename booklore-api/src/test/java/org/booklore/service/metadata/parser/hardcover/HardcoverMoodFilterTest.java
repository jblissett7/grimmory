...
class HardcoverMoodFilterTest {
  ...
  void filterBasicMoods_mixedCase_normalizesToLowercase() {
    ...
    assertThat(result).containsExactlyInAnyOrder("funny", "sad", "dark", "emotional");
  }
  ...
  void filterMoodsWithCounts_nullCachedTags_returnsEmptySet() {
    Set<String> result =
        HardcoverMoodFilter.filterMoodsWithCounts((Map<String, List<HardcoverCachedTag>>) null);
    assertThat(result).isEmpty();
  }
  ...
  void filterMoodsWithCounts_nullVoteCounts_handlesGracefully() {
    ...
    cachedTags.put(
        "Mood", List.of(createCachedTag("sad", 10), tagWithNullCount, createCachedTag("dark", 8)));
  ...
  void filterMoodsWithCounts_allZeroVotes_returnsEmpty() {
    Map<String, List<HardcoverCachedTag>> cachedTags = new HashMap<>();
    cachedTags.put("Mood", List.of(createCachedTag("sad", 0), createCachedTag("dark", 0)));

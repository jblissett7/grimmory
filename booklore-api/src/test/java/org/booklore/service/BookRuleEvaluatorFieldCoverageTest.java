...
class BookRuleEvaluatorFieldCoverageTest {
  ...
  private BookEntity createBook(String title, LibraryEntity lib, LibraryPathEntity libPath) {
    ...
    BookMetadataEntity metadata =
        BookMetadataEntity.builder().book(book).bookId(book.getId()).title(title).build();
    em.persist(metadata);
    em.flush();
  ...
  private UserBookProgressEntity createProgress(BookEntity book, ReadStatus status) {
    UserBookProgressEntity progress =
        UserBookProgressEntity.builder().user(user).book(book).readStatus(status).build();
    em.persist(progress);
    em.flush();
    return progress;
  }
  ...
  class LibraryFieldTests {
    ...
    void equals_matchesBookInLibrary() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.LIBRARY, RuleOperator.EQUALS, library.getId()));
    ...
    void notEquals_excludesBookInLibrary() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.LIBRARY, RuleOperator.NOT_EQUALS, library.getId()));
  ...
  class ShelfFieldTests {
    ...
    void equals_matchesBookOnShelf() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(
                  RuleField.SHELF, RuleOperator.EQUALS, List.of(String.valueOf(shelf.getId()))));
    ...
    void isNotEmpty_matchesBookWithShelves() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SHELF, RuleOperator.IS_NOT_EMPTY, null));
      assertThat(ids).contains(onShelf.getId());
  ...
  class MultiShelfFilterTests {
    ...
    void orGroup_multipleShelfEquals_noDuplicateRows() {
      ...
      assertThat(ids)
          .containsExactlyInAnyOrder(
              bookOnBoth.getId(), bookOnShelf1.getId(), bookOnShelf2.getId());
    ...
    void bookOnManyShelves_paginationReturnsCorrectCount() {
      ...
      List<Long> ids =
          findMatchingIdsPaged(
              singleRule(
                  RuleField.SHELF, RuleOperator.EQUALS, List.of(String.valueOf(shelf1.getId()))),
              5);
  ...
  class SubtitleFieldTests {
    ...
    void contains_matchesSubtitleSubstring() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SUBTITLE, RuleOperator.CONTAINS, "journey"));
    ...
    void equals_caseInsensitive() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.SUBTITLE, RuleOperator.EQUALS, "the complete guide"));
  ...
  class DescriptionFieldTests {
    ...
    void contains_matchesDescriptionSubstring() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.DESCRIPTION, RuleOperator.CONTAINS, "adventure"));
    ...
    void doesNotContain_excludesDescriptionSubstring() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.DESCRIPTION, RuleOperator.DOES_NOT_CONTAIN, "space"));
  ...
  class PublisherFieldTests {
    ...
    void equals_matchesPublisher() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.PUBLISHER, RuleOperator.EQUALS, "penguin random house"));
    ...
    void startsWith_matchesPublisherPrefix() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.PUBLISHER, RuleOperator.STARTS_WITH, "penguin"));
      assertThat(ids).contains(penguin.getId());
      assertThat(ids).doesNotContain(harper.getId());
    }
    ...
    void contains_matchesPublisherSubstring() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.PUBLISHER, RuleOperator.CONTAINS, "random"));
      assertThat(ids).contains(book.getId());
    }
  }
  ...
  class LanguageFieldTests {
    ...
    void notEquals_excludesLanguage() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.LANGUAGE, RuleOperator.NOT_EQUALS, "en"));
  ...
  class NarratorFieldTests {
    ...
    void contains_matchesNarratorName() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.NARRATOR, RuleOperator.CONTAINS, "fry"));
      assertThat(ids).contains(book1.getId());
      assertThat(ids).doesNotContain(book2.getId());
    }
    ...
    void equals_caseInsensitive() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.NARRATOR, RuleOperator.EQUALS, "stephen fry"));
      assertThat(ids).contains(book.getId());
    }
  }
  ...
  class IsbnFieldTests {
    ...
    void isbn13_equals_matchesExact() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.ISBN13, RuleOperator.EQUALS, "9781234567890"));
      assertThat(ids).contains(book.getId());
    ...
    void isbn10_contains_matchesSubstring() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.ISBN10, RuleOperator.CONTAINS, "01234"));
      assertThat(ids).contains(book.getId());
    }
  }
  ...
  class ContentRatingFieldTests {
    ...
    void equals_matchesContentRating() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.CONTENT_RATING, RuleOperator.EQUALS, "mature"));
  ...
  class SeriesNameFieldTests {
    ...
    void contains_matchesSeriesNameSubstring() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_NAME, RuleOperator.CONTAINS, "potter"));
    ...
    void startsWith_matchesSeriesNamePrefix() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_NAME, RuleOperator.STARTS_WITH, "harry"));
      assertThat(ids).contains(hp.getId());
      assertThat(ids).doesNotContain(lotr.getId());
    }
    ...
    void isEmpty_matchesNoSeriesName() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.SERIES_NAME, RuleOperator.IS_EMPTY, null));
  ...
  class LastReadTimeTests {
    ...
    void withinLast_matchesRecentlyRead() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.LAST_READ_TIME, RuleOperator.WITHIN_LAST, 7, null, "days"));
    ...
    void olderThan_matchesOldRead() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.LAST_READ_TIME, RuleOperator.OLDER_THAN, 30, null, "days"));
  ...
  class AddedOnRelativeDateTests {
    ...
    void olderThan_weeks_matchesOldBook() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.ADDED_ON, RuleOperator.OLDER_THAN, 2, null, "weeks"));
      assertThat(ids).contains(old.getId());
      assertThat(ids).doesNotContain(recent.getId());
    }
  }
  ...
  class PublishedDateFieldTests {
    ...
    void equals_matchesExactDate() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.PUBLISHED_DATE, RuleOperator.EQUALS, "2023-06-15"));
      assertThat(ids).contains(book.getId());
      assertThat(ids).doesNotContain(other.getId());
    }
    ...
    void isEmpty_matchesNullPublishedDate() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.PUBLISHED_DATE, RuleOperator.IS_EMPTY, null));
  ...
  class CategoryFieldTests {
    ...
    void contains_matchesCategorySubstring() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.CATEGORIES, RuleOperator.CONTAINS, "fiction"));
    ...
    void isEmpty_matchesBookWithNoCategories() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.CATEGORIES, RuleOperator.IS_EMPTY, null));
  ...
  class MoodFieldTests {
    ...
    void includesAny_matchesMood() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.MOODS, RuleOperator.INCLUDES_ANY, List.of("Dark")));
  ...
  class TagFieldTests {
    ...
    void includesAll_matchesBookWithAllTags() {
      ...
      List<Long> ids =
          findMatchingIds(
              singleRule(RuleField.TAGS, RuleOperator.INCLUDES_ALL, List.of("Tag1 FC", "Tag2 FC")));
  ...
  class IsPhysicalFieldTests {
    ...
    void notEquals_true_matchesDigital() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.IS_PHYSICAL, RuleOperator.NOT_EQUALS, "true"));
  ...
  class AbridgedFieldTests {
    ...
    void equals_false_matchesUnabridged() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.ABRIDGED, RuleOperator.EQUALS, "false"));
  ...
  class DateFinishedRelativeTests {
    ...
    void thisPeriod_year_matchesThisYearFinished() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.DATE_FINISHED, RuleOperator.THIS_PERIOD, "year"));
  ...
  class StringEdgeCaseTests {
    ...
    void endsWith_matchesTitleSuffix() {
      ...
      List<Long> ids =
          findMatchingIds(singleRule(RuleField.TITLE, RuleOperator.ENDS_WITH, "rings"));
      assertThat(ids).contains(book.getId());
      assertThat(ids).doesNotContain(other.getId());
    }
  }

...
class UserProvisioningServiceTest {
  ...
  @Mock private UserDefaultsService userDefaultsService;
  ...
  @Captor private ArgumentCaptor<BookLoreUserEntity> userCaptor;
  ...
  void provisionOidcUser_setsBasicFieldsCorrectly() {
    BookLoreUserEntity result =
        userProvisioningService.provisionOidcUser(
            ...
            "https://avatar.example.com/jdoe.png",
            provisionDetails);
  ...
  void provisionOidcUser_appliesPermissionsFromDefaultPermissionsList() {
    provisionDetails.setDefaultPermissions(
        List.of("permissionUpload", "permissionDownload", "permissionEditMetadata"));
  ...
  void provisionOidcUser_auditsUserCreated() {
    ...
    verify(auditService)
        .log(eq(AuditAction.USER_CREATED), eq("User"), eq(1L), eq("Created user: jdoe"));
  }
}

...
class BookGroupingServiceTest {
  ...
  @InjectMocks BookGroupingService bookGroupingService;
  ...
  private LibraryFile file(
      LibraryPathEntity path, String subPath, String name, BookFileType type, boolean folderBased) {
    return LibraryFile.builder()
        .libraryPathEntity(path)
        .fileSubPath(subPath)
        .fileName(name)
    ...
    List<LibraryFile> files =
        List.of(
            ...
            ebook(
                path,
                "",
                "History of Britain and Ireland The Definitive Visual Guide (DORLING KINDERSLEY.) (Z-Library).epub"),
            ebook(
                path,
                "",
                "The Strength of the Few (Hierarchy, Book Two) (James Islington) (z-library.sk, 1lib.sk, z-lib.sk).epub"),
            ebook(
                path,
                "",
                "Violet Thistlewaite Is Not a Villain Anymore (Emily Krempholtz) (z-library.sk, 1lib.sk, z-lib.sk).epub"));
    ...
    List<LibraryFile> files =
        List.of(
            ...
            ebook(
                ...
                "The Lesser Dead - Christopher Buehlman (2014).epub"),
            ebook(
                path,
                "Christopher Buehlman/Those Across the River",
                "Those Across the River - Christopher Buehlman (2011).epub"),
            ...
            ebook(
                ...
                "The Will of the Many (Hierarchy) - James Islington (2025).epub"));
  ...
  void structure3_bookPerFile_folderBasedAudiobooks() {
    ...
    List<LibraryFile> files =
        List.of(
            folderAudiobook(
                path,
                "J K Rowling - Harry Potter 1-7 Unabridged Audiobooks Narrated by Stephen Fry",
    ...
    List<LibraryFile> files =
        List.of(
            ...
            ebook(
                ...
                "The Hunger Games - Suzanne Collins (2010).azw3"),
            ebook(
                path,
                "Suzanne Collins/The Hunger Games",
                "The Hunger Games - Suzanne Collins (2010).epub"),
            ebook(
                path,
                "Suzanne Collins/The Hunger Games",
                "The Hunger Games - Suzanne Collins (2010).mobi"));
  ...
  void structure5_bookPerFile_formatSubfolders() {
    ...
    List<LibraryFile> files =
        List.of(
            ebook(
                path,
                "Brandon Sanderson - Mistborn Trilogy/Brandon Sanderson - Mistborn - EPUB",
            ...
            ebook(
                path,
                "Brandon Sanderson - Mistborn Trilogy/Brandon Sanderson - Mistborn - MOBI",
                "Brandon Sanderson - Mistborn 01 - The Final Empire.mobi"),
            ebook(
                path,
                "Brandon Sanderson - Mistborn Trilogy/Brandon Sanderson - Mistborn - MOBI",
                "Brandon Sanderson - Mistborn 02 - The Well of Ascension.mobi"),
            ebook(
                path,
                "Brandon Sanderson - Mistborn Trilogy/Brandon Sanderson - Mistborn - MOBI",
                "Brandon Sanderson - Mistborn 03 - The Hero of Ages.mobi"));
    ...
    List<LibraryFile> files =
        List.of(
            ...
            ebook(
                ...
                "Gulliver's Travels - Jonathan Swift (2013).epub"),
            audiobook(
                path,
                "Jonathan Swift/Gulliver's Travels",
                "Gulliver's Travels - Jonathan Swift (2013).m4b"),
            ebook(
                path,
                "Jonathan Swift/Gulliver's Travels",
                "Gulliver's Travels - Jonathan Swift (2013).mobi"),
            ebook(path, "", "Hansel and Gretel - Stephen King (2025).epub"),
            audiobook(path, "", "Hansel and Gretel (2025).m4b"));
  ...
  void structure7_bookPerFile_titleFolders() {
    ...
    List<LibraryFile> files =
        List.of(
            ebook(
                path,
                "Oathbringer_ The Stormlight Archive Book Three",
                "Oathbringer_ The Stormlight Archive Book T - Brandon Sanderson.azw3"),
            ebook(
                path,
                "Oathbringer_ The Stormlight Archive Book Three",
                "Oathbringer_ The Stormlight Archive Book T - Brandon Sanderson.epub"),
            ebook(
                path,
                "Oathbringer_ The Stormlight Archive Book Three",
                "Oathbringer_ The Stormlight Archive Book T - Brandon Sanderson.mobi"),
            ...
            ebook(
                ...
                "Rhythm of War (The Stormlight Archive Book 4) - Brandon Sanderson.azw3"),
            ebook(
                path,
                "Rhythm of War (Stormlight Archive Book 4) - Brandon Sanderson",
            ...
            ebook(
                path,
                "Rhythm of War (Stormlight Archive Book 4) - Brandon Sanderson",
                "Rhythm of War (The Stormlight Archive Book 4) - Brandon Sanderson.mobi"),
    ...
    List<LibraryFile> files =
        List.of(
            ebook(
                ...
                "Prince Caspian - C. S. Lewis (2013).azw3"),
            ebook(
                path,
                "C. S. Lewis/The Chronicles of Narnia/Prince Caspian",
                "Prince Caspian - C. S. Lewis (2013).epub"),
            ebook(
                path,
                "C. S. Lewis/The Chronicles of Narnia/Prince Caspian",
                "Prince Caspian - C. S. Lewis (2013).mobi"),
            ebook(
                path,
                "C. S. Lewis/The Chronicles of Narnia/The Horse and His Boy The Chronicles of Narnia",
                "The Horse and His Boy - C. S. Lewis.azw3"),
            ebook(
                path,
                "C. S. Lewis/The Chronicles of Narnia/The Horse and His Boy The Chronicles of Narnia",
                "The Horse and His Boy - C. S. Lewis.epub"),
            ebook(
                path,
                "C. S. Lewis/The Chronicles of Narnia/The Horse and His Boy The Chronicles of Narnia",
                "The Horse and His Boy - C. S. Lewis.mobi"),
            ebook(
                path,
                "C. S. Lewis/The Chronicles of Narnia/The Magician's Nephew The Chronicles of Narnia",
                "The Magician's Nephew - C. S. Lewis (2013).epub"),
            ebook(
                path,
                "C. S. Lewis/The Chronicles of Narnia/The Magician's Nephew The Chronicles of Narnia",
                "The Magician's Nephew - C. S. Lewis.azw3"),
            ebook(
                path,
                "C. S. Lewis/The Chronicles of Narnia/The Magician's Nephew The Chronicles of Narnia",
            ...
            ebook(
                ...
                "The Silver Chair - C. S. Lewis (2013).epub"));
    ...
    List<LibraryFile> files =
        List.of(
            ebook(
                ...
                "Harry Potter and the Chamber of Secrets - J.K. Rowling (2019).fb2"),
            ebook(
                path,
                "J.K. Rowling/Harry Potter and the Chamber of Secrets",
                "Harry Potter and the Chamber of Secrets - J.K. Rowling (2019).pdf"),
            ebook(
                path,
                "J.K. Rowling/Harry Potter and the Chamber of Secrets",
                "Harry Potter and the Chamber of Secrets - J.K. Rowling.azw3"),
            ebook(
                path,
                "J.K. Rowling/Harry Potter and the Chamber of Secrets",
                "Harry Potter and the Chamber of Secrets - J.K. Rowling.epub"),
            ebook(
                path,
                "J.K. Rowling/Harry Potter and the Cursed Child",
                "Harry Potter and the Cursed Child - J.K. Rowling (2017).epub"),
            ebook(
                path,
                "J.K. Rowling/Harry Potter and the Deathly Hallows",
                "Harry Potter and the Deathly Hallows - J.K. Rowling.azw3"),
            ebook(
                path,
                "J.K. Rowling/Harry Potter and the Deathly Hallows",
                "Harry Potter and the Deathly Hallows - J.K. Rowling.epub"),
            ebook(
                path,
                "J.K. Rowling/Harry Potter and the Goblet of Fire",
                "Harry Potter and the Goblet of Fire - J.K. Rowling.epub"),
            ebook(
                path,
                "J.K. Rowling/Harry Potter and the Goblet of Fire",
                "Harry Potter and the Goblet of Fire - J.K. Rowling.mobi"),
            ebook(
                path,
                "J.K. Rowling/Harry Potter and the Goblet of Fire",
                "Harry Potter and the Goblet of Fire - J.K. Rowling.pdf"),
            ebook(
                path,
                "J.K. Rowling/Harry Potter and the Half-Blood Prince",
                "Harry Potter and the Half-Blood Prince - J.K. Rowling.epub"),
            ebook(
                path,
                "J.K. Rowling/Harry Potter and the Philosopher's Stone",
                "Harry Potter and the Philosopher's Stone - J.K. Rowling.azw3"),
            ebook(
                path,
                "J.K. Rowling/Harry Potter and the Philosopher's Stone",
    ...
    List<LibraryFile> files =
        List.of(
            ...
            folderAudiobook(
                path,
                "J K Rowling - Harry Potter 1-7 Unabridged Audiobooks Narrated by Stephen Fry",
                "5 HARRY POTTER ANND THE ORDER OF THE PHOENIX"),
            folderAudiobook(
                path,
                "J K Rowling - Harry Potter 1-7 Unabridged Audiobooks Narrated by Stephen Fry",

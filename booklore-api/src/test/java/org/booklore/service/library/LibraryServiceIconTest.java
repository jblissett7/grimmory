...
class LibraryServiceIconTest {
  ...
  void updateLibrary_withNullIcon_shouldClearIconValues() {
    ...
    when(libraryRepository.save(any(LibraryEntity.class)))
        .thenAnswer(invocation -> invocation.getArgument(0));
    when(libraryMapper.toLibrary(any(LibraryEntity.class)))
        .thenReturn(Library.builder().name("Updated Library").build());
  ...
  void updateLibrary_fromIconToNull_shouldAllowRemovingIcon() {
    ...
    when(libraryRepository.save(any(LibraryEntity.class)))
        .thenAnswer(invocation -> invocation.getArgument(0));
    when(libraryMapper.toLibrary(any(LibraryEntity.class)))
        .thenReturn(Library.builder().name("Library With Icon").build());
  ...
  void createLibrary_withNullIcon_shouldPersistNullIconValues() {
    ...
    when(libraryMapper.toLibrary(any(LibraryEntity.class)))
        .thenReturn(Library.builder().name("No Icon Library").build());

...
class OpdsUserV2ServiceTest {
  ...
  @Mock private OpdsUserV2Repository opdsUserV2Repository;
  @Mock private AuthenticationService authenticationService;
  @Mock private UserRepository userRepository;
  @Mock private OpdsUserV2Mapper mapper;
  @Mock private PasswordEncoder passwordEncoder;
  @Mock private AuditService auditService;

  @InjectMocks private OpdsUserV2Service service;

  @Captor private ArgumentCaptor<OpdsUserV2Entity> entityCaptor;
  ...
  void createOpdsUser_passwordEncoderThrows_propagatesException() {
    ...
    when(passwordEncoder.encode("plaintext"))

...
public class BookMetadataMapperTest {
  ...
  @Mock private MoodMapper moodMapper;

  @Mock private TagMapper tagMapper;

  @Mock private ComicMetadataMapper comicMetadataMapper;
  ...
  void setUp() {
    ...
    org.springframework.test.util.ReflectionTestUtils.setField(
        bookMetadataMapper, "authorMapper", authorMapper);
    org.springframework.test.util.ReflectionTestUtils.setField(
        bookMetadataMapper, "categoryMapper", categoryMapper);
    org.springframework.test.util.ReflectionTestUtils.setField(
        bookMetadataMapper, "moodMapper", moodMapper);
    org.springframework.test.util.ReflectionTestUtils.setField(
        bookMetadataMapper, "tagMapper", tagMapper);
    org.springframework.test.util.ReflectionTestUtils.setField(
        bookMetadataMapper, "comicMetadataMapper", comicMetadataMapper);
  }

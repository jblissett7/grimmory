...
public class MetadataChangeDetector {
  ...
  private static final List<FieldDescriptor<?>> SIMPLE_FIELDS =
      List.of(
          new FieldDescriptor<>(
              "title",
              BookMetadata::getTitle,
              BookMetadataEntity::getTitle,
              BookMetadata::getTitleLocked,
              BookMetadataEntity::getTitleLocked,
              MetadataClearFlags::isTitle,
              true),
          new FieldDescriptor<>(
              "subtitle",
              BookMetadata::getSubtitle,
              BookMetadataEntity::getSubtitle,
              BookMetadata::getSubtitleLocked,
              BookMetadataEntity::getSubtitleLocked,
              MetadataClearFlags::isSubtitle,
              true),
          new FieldDescriptor<>(
              "publisher",
              BookMetadata::getPublisher,
              BookMetadataEntity::getPublisher,
              BookMetadata::getPublisherLocked,
              BookMetadataEntity::getPublisherLocked,
              MetadataClearFlags::isPublisher,
              true),
          new FieldDescriptor<>(
              "publishedDate",
              BookMetadata::getPublishedDate,
              BookMetadataEntity::getPublishedDate,
              BookMetadata::getPublishedDateLocked,
              BookMetadataEntity::getPublishedDateLocked,
              MetadataClearFlags::isPublishedDate,
              true),
          new FieldDescriptor<>(
              "description",
              BookMetadata::getDescription,
              BookMetadataEntity::getDescription,
              BookMetadata::getDescriptionLocked,
              BookMetadataEntity::getDescriptionLocked,
              MetadataClearFlags::isDescription,
              true),
          new FieldDescriptor<>(
              "seriesName",
              BookMetadata::getSeriesName,
              BookMetadataEntity::getSeriesName,
              BookMetadata::getSeriesNameLocked,
              BookMetadataEntity::getSeriesNameLocked,
              MetadataClearFlags::isSeriesName,
              true),
          new FieldDescriptor<>(
              "seriesNumber",
              BookMetadata::getSeriesNumber,
              BookMetadataEntity::getSeriesNumber,
              BookMetadata::getSeriesNumberLocked,
              BookMetadataEntity::getSeriesNumberLocked,
              MetadataClearFlags::isSeriesNumber,
              true),
          new FieldDescriptor<>(
              "seriesTotal",
              BookMetadata::getSeriesTotal,
              BookMetadataEntity::getSeriesTotal,
              BookMetadata::getSeriesTotalLocked,
              BookMetadataEntity::getSeriesTotalLocked,
              MetadataClearFlags::isSeriesTotal,
              true),
          new FieldDescriptor<>(
              "isbn13",
              BookMetadata::getIsbn13,
              BookMetadataEntity::getIsbn13,
              BookMetadata::getIsbn13Locked,
              BookMetadataEntity::getIsbn13Locked,
              MetadataClearFlags::isIsbn13,
              true),
          new FieldDescriptor<>(
              "isbn10",
              BookMetadata::getIsbn10,
              BookMetadataEntity::getIsbn10,
              BookMetadata::getIsbn10Locked,
              BookMetadataEntity::getIsbn10Locked,
              MetadataClearFlags::isIsbn10,
              true),
          new FieldDescriptor<>(
              "asin",
              BookMetadata::getAsin,
              BookMetadataEntity::getAsin,
              BookMetadata::getAsinLocked,
              BookMetadataEntity::getAsinLocked,
              MetadataClearFlags::isAsin,
              true),
          new FieldDescriptor<>(
              "goodreadsId",
              BookMetadata::getGoodreadsId,
              BookMetadataEntity::getGoodreadsId,
              BookMetadata::getGoodreadsIdLocked,
              BookMetadataEntity::getGoodreadsIdLocked,
              MetadataClearFlags::isGoodreadsId,
              true),
          new FieldDescriptor<>(
              "comicvineId",
              BookMetadata::getComicvineId,
              BookMetadataEntity::getComicvineId,
              BookMetadata::getComicvineIdLocked,
              BookMetadataEntity::getComicvineIdLocked,
              MetadataClearFlags::isComicvineId,
              true),
          new FieldDescriptor<>(
              "hardcoverId",
              BookMetadata::getHardcoverId,
              BookMetadataEntity::getHardcoverId,
              BookMetadata::getHardcoverIdLocked,
              BookMetadataEntity::getHardcoverIdLocked,
              MetadataClearFlags::isHardcoverId,
              true),
          new FieldDescriptor<>(
              "hardcoverBookId",
              BookMetadata::getHardcoverBookId,
              BookMetadataEntity::getHardcoverBookId,
              BookMetadata::getHardcoverBookIdLocked,
              BookMetadataEntity::getHardcoverBookIdLocked,
              MetadataClearFlags::isHardcoverBookId,
              true),
          new FieldDescriptor<>(
              "googleId",
              BookMetadata::getGoogleId,
              BookMetadataEntity::getGoogleId,
              BookMetadata::getGoogleIdLocked,
              BookMetadataEntity::getGoogleIdLocked,
              MetadataClearFlags::isGoogleId,
              true),
          new FieldDescriptor<>(
              "lubimyczytacId",
              BookMetadata::getLubimyczytacId,
              BookMetadataEntity::getLubimyczytacId,
              BookMetadata::getLubimyczytacIdLocked,
              BookMetadataEntity::getLubimyczytacIdLocked,
              MetadataClearFlags::isLubimyczytacId,
              true),
          new FieldDescriptor<>(
              "ranobedbId",
              BookMetadata::getRanobedbId,
              BookMetadataEntity::getRanobedbId,
              BookMetadata::getRanobedbIdLocked,
              BookMetadataEntity::getRanobedbIdLocked,
              MetadataClearFlags::isRanobedbId,
              true),
          new FieldDescriptor<>(
              "language",
              BookMetadata::getLanguage,
              BookMetadataEntity::getLanguage,
              BookMetadata::getLanguageLocked,
              BookMetadataEntity::getLanguageLocked,
              MetadataClearFlags::isLanguage,
              true),
          new FieldDescriptor<>(
              "pageCount",
              BookMetadata::getPageCount,
              BookMetadataEntity::getPageCount,
              BookMetadata::getPageCountLocked,
              BookMetadataEntity::getPageCountLocked,
              MetadataClearFlags::isPageCount,
              false),
          new FieldDescriptor<>(
              "amazonRating",
              BookMetadata::getAmazonRating,
              BookMetadataEntity::getAmazonRating,
              BookMetadata::getAmazonRatingLocked,
              BookMetadataEntity::getAmazonRatingLocked,
              MetadataClearFlags::isAmazonRating,
              false),
          new FieldDescriptor<>(
              "amazonReviewCount",
              BookMetadata::getAmazonReviewCount,
              BookMetadataEntity::getAmazonReviewCount,
              BookMetadata::getAmazonReviewCountLocked,
              BookMetadataEntity::getAmazonReviewCountLocked,
              MetadataClearFlags::isAmazonReviewCount,
              false),
          new FieldDescriptor<>(
              "goodreadsRating",
              BookMetadata::getGoodreadsRating,
              BookMetadataEntity::getGoodreadsRating,
              BookMetadata::getGoodreadsRatingLocked,
              BookMetadataEntity::getGoodreadsRatingLocked,
              MetadataClearFlags::isGoodreadsRating,
              false),
          new FieldDescriptor<>(
              "goodreadsReviewCount",
              BookMetadata::getGoodreadsReviewCount,
              BookMetadataEntity::getGoodreadsReviewCount,
              BookMetadata::getGoodreadsReviewCountLocked,
              BookMetadataEntity::getGoodreadsReviewCountLocked,
              MetadataClearFlags::isGoodreadsReviewCount,
              false),
          new FieldDescriptor<>(
              "hardcoverRating",
              BookMetadata::getHardcoverRating,
              BookMetadataEntity::getHardcoverRating,
              BookMetadata::getHardcoverRatingLocked,
              BookMetadataEntity::getHardcoverRatingLocked,
              MetadataClearFlags::isHardcoverRating,
              false),
          new FieldDescriptor<>(
              "hardcoverReviewCount",
              BookMetadata::getHardcoverReviewCount,
              BookMetadataEntity::getHardcoverReviewCount,
              BookMetadata::getHardcoverReviewCountLocked,
              BookMetadataEntity::getHardcoverReviewCountLocked,
              MetadataClearFlags::isHardcoverReviewCount,
              false),
          new FieldDescriptor<>(
              "lubimyczytacRating",
              BookMetadata::getLubimyczytacRating,
              BookMetadataEntity::getLubimyczytacRating,
              BookMetadata::getLubimyczytacRatingLocked,
              BookMetadataEntity::getLubimyczytacRatingLocked,
              MetadataClearFlags::isLubimyczytacRating,
              false),
          new FieldDescriptor<>(
              "ranobedbRating",
              BookMetadata::getRanobedbRating,
              BookMetadataEntity::getRanobedbRating,
              BookMetadata::getRanobedbRatingLocked,
              BookMetadataEntity::getRanobedbRatingLocked,
              MetadataClearFlags::isRanobedbRating,
              false),
          new FieldDescriptor<>(
              "audibleId",
              BookMetadata::getAudibleId,
              BookMetadataEntity::getAudibleId,
              BookMetadata::getAudibleIdLocked,
              BookMetadataEntity::getAudibleIdLocked,
              MetadataClearFlags::isAudibleId,
              false),
          new FieldDescriptor<>(
              "audibleRating",
              BookMetadata::getAudibleRating,
              BookMetadataEntity::getAudibleRating,
              BookMetadata::getAudibleRatingLocked,
              BookMetadataEntity::getAudibleRatingLocked,
              MetadataClearFlags::isAudibleRating,
              false),
          new FieldDescriptor<>(
              "audibleReviewCount",
              BookMetadata::getAudibleReviewCount,
              BookMetadataEntity::getAudibleReviewCount,
              BookMetadata::getAudibleReviewCountLocked,
              BookMetadataEntity::getAudibleReviewCountLocked,
              MetadataClearFlags::isAudibleReviewCount,
              false),
          new FieldDescriptor<>(
              "narrator",
              BookMetadata::getNarrator,
              BookMetadataEntity::getNarrator,
              BookMetadata::getNarratorLocked,
              BookMetadataEntity::getNarratorLocked,
              MetadataClearFlags::isNarrator,
              false),
          new FieldDescriptor<>(
              "abridged",
              BookMetadata::getAbridged,
              BookMetadataEntity::getAbridged,
              BookMetadata::getAbridgedLocked,
              BookMetadataEntity::getAbridgedLocked,
              MetadataClearFlags::isAbridged,
              false),
          new FieldDescriptor<>(
              "ageRating",
              BookMetadata::getAgeRating,
              BookMetadataEntity::getAgeRating,
              BookMetadata::getAgeRatingLocked,
              BookMetadataEntity::getAgeRatingLocked,
              MetadataClearFlags::isAgeRating,
              true),
          new FieldDescriptor<>(
              "contentRating",
              BookMetadata::getContentRating,
              BookMetadataEntity::getContentRating,
              BookMetadata::getContentRatingLocked,
              BookMetadataEntity::getContentRatingLocked,
              MetadataClearFlags::isContentRating,
              true));

  private static final List<CollectionFieldDescriptor> COLLECTION_FIELDS =
      List.of(
          new CollectionFieldDescriptor(
              "authors",
              BookMetadata::getAuthors,
              BookMetadataEntity::getAuthors,
              BookMetadata::getAuthorsLocked,
              BookMetadataEntity::getAuthorsLocked,
              MetadataClearFlags::isAuthors,
              true,
              true),
          new CollectionFieldDescriptor(
              "categories",
              BookMetadata::getCategories,
              BookMetadataEntity::getCategories,
              BookMetadata::getCategoriesLocked,
              BookMetadataEntity::getCategoriesLocked,
              MetadataClearFlags::isCategories,
              true),
          new CollectionFieldDescriptor(
              "moods",
              BookMetadata::getMoods,
              BookMetadataEntity::getMoods,
              BookMetadata::getMoodsLocked,
              BookMetadataEntity::getMoodsLocked,
              MetadataClearFlags::isMoods,
              false),
          new CollectionFieldDescriptor(
              "tags",
              BookMetadata::getTags,
              BookMetadataEntity::getTags,
              BookMetadata::getTagsLocked,
              BookMetadataEntity::getTagsLocked,
              MetadataClearFlags::isTags,
              false));

  public static boolean isDifferent(
      BookMetadata newMeta, BookMetadataEntity existingMeta, MetadataClearFlags clear) {
    ...
    return differsLock(newMeta.getCoverLocked(), existingMeta.getCoverLocked())
        || differsLock(newMeta.getAudiobookCoverLocked(), existingMeta.getAudiobookCoverLocked());
  }

  public static boolean hasValueChanges(
      BookMetadata newMeta, BookMetadataEntity existingMeta, MetadataClearFlags clear) {
    for (FieldDescriptor<?> field : SIMPLE_FIELDS) {
  ...
  public static boolean hasValueChangesForFileWrite(
      BookMetadata newMeta, BookMetadataEntity existingMeta, MetadataClearFlags clear) {
    for (FieldDescriptor<?> field : SIMPLE_FIELDS) {
    ...
    for (CollectionFieldDescriptor field : COLLECTION_FIELDS) {
      if (field.includedInFileWrite()
          && hasCollectionValueDifference(field, newMeta, existingMeta, clear)) {
        return true;
      }
    }
    return false;
  ...
  private static <T> boolean hasFieldDifference(
      FieldDescriptor<T> field,
      BookMetadata newMeta,
      BookMetadataEntity existingMeta,
      MetadataClearFlags clear) {
  ...
  private static boolean hasCollectionFieldDifference(
      CollectionFieldDescriptor field,
      BookMetadata newMeta,
      BookMetadataEntity existingMeta,
      MetadataClearFlags clear) {
    boolean valueChanged =
  ...
  private static <T> boolean hasValueDifference(
      FieldDescriptor<T> field,
      BookMetadata newMeta,
      BookMetadataEntity existingMeta,
      MetadataClearFlags clear) {
  ...
  private static boolean hasCollectionValueDifference(
      CollectionFieldDescriptor field,
      BookMetadata newMeta,
      BookMetadataEntity existingMeta,
      MetadataClearFlags clear) {
  ...
  private static boolean differs(
      boolean shouldClear, Object newVal, Object oldVal, boolean isUnlocked) {
  ...
  private static boolean hasComicMetadataChanges(
      BookMetadata newMeta, BookMetadataEntity existingMeta) {
    ...
    return differsValue(comicDto.getIssueNumber(), comicEntity.getIssueNumber())
        ...
        || !stringSetsEqual(
            comicDto.getCharacters(), extractCharacterNames(comicEntity.getCharacters()))
        || !stringSetsEqual(comicDto.getTeams(), extractTeamNames(comicEntity.getTeams()))
        || !stringSetsEqual(
            comicDto.getLocations(), extractLocationNames(comicEntity.getLocations()))
        || hasCreatorChanges(comicDto, comicEntity);
  }

  private static boolean hasComicLockChanges(
      BookMetadata newMeta, BookMetadataEntity existingMeta) {
    ComicMetadata comicDto = newMeta.getComicMetadata();
    ComicMetadataEntity comicEntity = existingMeta.getComicMetadata();
    ...
    return differsLock(comicDto.getIssueNumberLocked(), comicEntity.getIssueNumberLocked())
        ...
        || differsLock(
            comicDto.getReadingDirectionLocked(), comicEntity.getReadingDirectionLocked())
  ...
  public static boolean hasLockChanges(BookMetadata newMeta, BookMetadataEntity existingMeta) {
    ...
    if (differsLock(newMeta.getAudiobookCoverLocked(), existingMeta.getAudiobookCoverLocked()))
      return true;
  ...
  private static boolean hasCreatorChanges(ComicMetadata dto, ComicMetadataEntity entity) {
    ...
    boolean entityHasCreators =
        entity.getCreatorMappings() != null && !entity.getCreatorMappings().isEmpty();
    ...
    int dtoCount =
        countNonNull(dto.getPencillers())
            + countNonNull(dto.getInkers())
            + countNonNull(dto.getColorists())
            + countNonNull(dto.getLetterers())
            + countNonNull(dto.getCoverArtists())
            + countNonNull(dto.getEditors());

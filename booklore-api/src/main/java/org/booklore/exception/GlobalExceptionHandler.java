...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleHttpMessageNotReadableException(
    ...
    ErrorResponse errorResponse =
        new ErrorResponse(HttpStatus.BAD_REQUEST.value(), "Request body is missing or malformed.");
  ...
  public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
    ...
    ErrorResponse errorResponse =
        new ErrorResponse(
            ...
            "A data conflict occurred. The operation could not be completed.");
    return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
  }
  ...
  public ResponseEntity<ErrorResponse> handleNoResourceFoundException(NoResourceFoundException ex) {
    ErrorResponse errorResponse =
        new ErrorResponse(HttpStatus.NOT_FOUND.value(), "Resource not found: " + ex.getMessage());
  ...
  public ResponseEntity<ErrorResponse> handleInterruptedException(InterruptedException ex) {
    log.info(
        ...
        ex.getMessage() != null ? ex.getMessage() : "Thread interrupted");
    Thread.currentThread().interrupt();
    ErrorResponse errorResponse =
        new ErrorResponse(HttpStatus.OK.value(), "Request was cancelled.");
  ...
  public ResponseEntity<ErrorResponse> handleUnsupportedOperationException(
    ...
    ErrorResponse errorResponse =
        new ErrorResponse(HttpStatus.NOT_IMPLEMENTED.value(), ex.getMessage());

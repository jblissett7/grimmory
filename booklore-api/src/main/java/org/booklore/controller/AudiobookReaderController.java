...
public class AudiobookReaderController {
  ...
  @Operation(
      ...
      description =
          "Retrieve metadata including duration, chapters/tracks, and audio details for an audiobook.")
  ...
  public ResponseEntity<AudiobookInfo> getAudiobookInfo(
      ...
      @Parameter(description = "Optional book type for alternative format (e.g., AUDIOBOOK)")
  ...
  @Operation(
      ...
      description =
          "Stream the audiobook audio file with HTTP Range support for seeking. "
  ...
  public void streamAudiobook(
      @Parameter(description = "ID of the book") @PathVariable Long bookId,
      @Parameter(description = "Optional book type for alternative format")
          @RequestParam(required = false)
          String bookType,
      @Parameter(description = "Track index for folder-based audiobooks (0-indexed)")
          @RequestParam(required = false)
          Integer trackIndex,
  ...
  @Operation(
      ...
      description =
          "Extract and return the embedded cover art from the audiobook file. "

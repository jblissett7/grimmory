...
public class BookdropFileController {
  ...
  public Page<BookdropFile> getFilesByStatus(
      @Parameter(description = "Status to filter files by") @RequestParam(required = false)
          String status,
      Pageable pageable) {
  ...
  public ResponseEntity<Void> discardSelectedFiles(
      @Parameter(description = "Selection request for files to discard") @RequestBody
          BookdropSelectionRequest request) {
    bookDropService.discardSelectedFiles(
  ...
  public ResponseEntity<BookdropFinalizeResult> finalizeImport(
      @Parameter(description = "Finalize import request") @RequestBody
  ...
  public ResponseEntity<BookdropPatternExtractResult> extractFromPattern(
      @Parameter(description = "Pattern extraction request") @Valid @RequestBody
          BookdropPatternExtractRequest request) {
  ...
  public ResponseEntity<BookdropBulkEditResult> bulkEditMetadata(
      @Parameter(description = "Bulk edit request") @Valid @RequestBody

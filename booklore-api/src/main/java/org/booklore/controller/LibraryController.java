...
public class LibraryController {
  ...
  @Operation(
      ...
      description = "Check accessibility of all library paths.")
  ...
  public ResponseEntity<Library> createLibrary(
      @Parameter(description = "Library creation request") @Validated @RequestBody
  ...
  public ResponseEntity<Library> updateLibrary(
      @Parameter(description = "Library update request") @Validated @RequestBody
          CreateLibraryRequest request,
      @Parameter(description = "ID of the library") @PathVariable Long libraryId) {
  ...
  @Operation(
      summary = "Get book counts by format",
      description = "Get the count of books for each format in a library.")

...
public class UserController {
  ...
  public ResponseEntity<BookLoreUser> updateUser(
      @Parameter(description = "ID of the user") @PathVariable Long id,
      @Parameter(description = "User update request") @Valid @RequestBody
  ...
  public ResponseEntity<?> changePassword(
      @Parameter(description = "Change password request") @RequestBody @Valid
  ...
  public ResponseEntity<?> changeUserPassword(
      @Parameter(description = "Change user password request") @RequestBody @Valid
  ...
  public void updateUserSetting(
      @Parameter(description = "ID of the user") @PathVariable Long id,
      @Parameter(description = "Update user setting request") @RequestBody @Valid

...
public class ReadingSessionController {
  ...
  @PostMapping
  public ResponseEntity<Void> recordReadingSession(
      @RequestBody @Valid ReadingSessionRequest request) {
  ...
  public ResponseEntity<Page<ReadingSessionResponse>> getReadingSessionsForBook(
    ...
    Page<ReadingSessionResponse> sessions =
        readingSessionService.getReadingSessionsForBook(bookId, page, size);

...
public class MetadataTaskController {
  ...
  @Operation(
      ...
      description =
          "Retrieve a metadata task and its proposals by task ID. Requires metadata edit permission or admin.")
  ...
  @Operation(
      ...
      description =
          "Retrieve all active metadata batch tasks. Requires metadata edit permission or admin.")
  ...
  @Operation(
      ...
      description =
          "Delete a metadata task and its proposals by task ID. Requires metadata edit permission or admin.")

...
@Tag(
    name = "OPDS",
    description =
        "Endpoints for OPDS catalog feeds, book downloads, covers, and search description")
@Slf4j
@RestController
...
public class OpdsController {
  ...
  private static final String OPDS_CATALOG_MEDIA_TYPE =
      "application/atom+xml;profile=opds-catalog;kind=navigation;charset=utf-8";
  private static final String OPDS_ACQUISITION_MEDIA_TYPE =
  ...
  public ResponseEntity<Resource> downloadBook(
      ...
      @Parameter(description = "Optional ID of a specific file format to download")
  ...
  public ResponseEntity<Resource> getBookCover(
    ...
    return ResponseEntity.ok()
        ...
        .header(
            ...
            "inline; filename=\"" + coverImage.getFilename() + "\"")
        .body(coverImage);
  }
  ...
  public ResponseEntity<String> getMagicShelvesNavigation(
      @Parameter(hidden = true) HttpServletRequest request) {
  ...
  public ResponseEntity<String> getAuthorsNavigation(
      @Parameter(hidden = true) HttpServletRequest request) {
  ...
  public ResponseEntity<String> getSeriesNavigation(
      @Parameter(hidden = true) HttpServletRequest request) {
  ...
  public ResponseEntity<String> getSearchDescription() {
    ...
    return ResponseEntity.ok()
        .contentType(
            MediaType.parseMediaType("application/opensearchdescription+xml;charset=utf-8"))
        .body(searchDoc);
  }

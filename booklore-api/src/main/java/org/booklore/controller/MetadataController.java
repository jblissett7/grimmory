...
public class MetadataController {
  ...
  @PostMapping(
      value = "/{bookId}/metadata/prospective",
      produces = MediaType.TEXT_EVENT_STREAM_VALUE)
  @PreAuthorize("@securityUtil.canEditMetadata() or @securityUtil.isAdmin()")
  @CheckBookAccess(bookIdParam = "bookId")
  public Flux<BookMetadata> getMetadataList(
      @Parameter(description = "Fetch metadata request") @RequestBody(required = false)
          FetchMetadataRequest fetchMetadataRequest,
  ...
  public ResponseEntity<BookMetadata> updateMetadata(
      @Parameter(description = "Metadata update wrapper") @RequestBody
          MetadataUpdateWrapper metadataUpdateWrapper,
      @Parameter(description = "ID of the book") @PathVariable long bookId,
      @Parameter(description = "Merge categories") @RequestParam(defaultValue = "false")
          boolean mergeCategories,
      @Parameter(description = "Replace mode") @RequestParam(defaultValue = "REPLACE_ALL")
          MetadataReplaceMode replaceMode) {
    BookEntity bookEntity =
        bookRepository.findAllWithMetadataByIds(java.util.Collections.singleton(bookId)).stream()
            .findFirst()
  ...
  public ResponseEntity<Void> bulkEditMetadata(
      @Parameter(description = "Bulk metadata update request") @RequestBody
          BulkMetadataUpdateRequest bulkMetadataUpdateRequest) {
    ...
    bookMetadataService.bulkUpdateMetadata(
        bulkMetadataUpdateRequest, mergeCategories, mergeMoods, mergeTags);
  ...
  @Operation(
      ...
      description =
          "Toggle all metadata locks for books. Requires metadata edit permission or admin.")
  ...
  public ResponseEntity<List<BookMetadata>> toggleAllMetadata(
      @Parameter(description = "Toggle all lock request") @RequestBody
          ToggleAllLockRequest request) {
  ...
  public ResponseEntity<List<BookMetadata>> toggleFieldLocks(
      @Parameter(description = "Toggle field locks request") @RequestBody
          ToggleFieldLocksRequest request) {
  ...
  public ResponseEntity<Void> mergeMetadata(
      @Parameter(description = "Merge metadata request") @Validated @RequestBody
          MergeMetadataRequest request) {
    metadataManagementService.consolidateMetadata(
        request.getMetadataType(), request.getTargetValues(), request.getValuesToMerge());
    return ResponseEntity.noContent().build();
  }
  ...
  public ResponseEntity<Void> deleteMetadata(
      @Parameter(description = "Delete metadata request") @Validated @RequestBody
          DeleteMetadataRequest request) {
    metadataManagementService.deleteMetadata(
        request.getMetadataType(), request.getValuesToDelete());
    return ResponseEntity.noContent().build();
  }

  @Operation(
      summary = "Lookup metadata by ISBN",
      description =
          "Fetch metadata for a book by ISBN. Requires library management permission or admin.")
  ...
  @Operation(
      summary = "Get detailed metadata from provider",
      description =
          "Fetch full metadata details for a specific item from a provider. Requires metadata edit permission or admin.")
  ...
  public ResponseEntity<BookMetadata> getDetailedProviderMetadata(
    ...
    BookMetadata metadata =
        bookMetadataService.getDetailedProviderMetadata(provider, providerItemId);
    if (metadata == null) {
      return ResponseEntity.notFound().build();
    }
    return ResponseEntity.ok(metadata);

...
public class OpdsUserV2Controller {
  ...
  public OpdsUserV2 createUser(
      @Parameter(description = "OPDS user creation request") @RequestBody @Valid
          OpdsUserV2CreateRequest createRequest) {
  ...
  public OpdsUserV2 updateUser(
      ...
      @Parameter(description = "OPDS user update request") @RequestBody @Valid
          OpdsUserV2UpdateRequest updateRequest) {

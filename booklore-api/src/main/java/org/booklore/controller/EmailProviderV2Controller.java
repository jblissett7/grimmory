...
public class EmailProviderV2Controller {
  ...
  public ResponseEntity<EmailProviderV2> createEmailProvider(
      @Parameter(description = "Email provider creation request") @RequestBody @Valid
          CreateEmailProviderRequest createEmailProviderRequest) {
  ...
  public ResponseEntity<EmailProviderV2> updateEmailProvider(
      @Parameter(description = "ID of the email provider") @PathVariable Long id,
      @Parameter(description = "Email provider update request") @RequestBody @Valid
          CreateEmailProviderRequest updateRequest) {

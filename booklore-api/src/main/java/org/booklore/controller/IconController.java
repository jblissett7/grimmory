...
public class IconController {
  ...
  public ResponseEntity<?> saveSvgIcon(
      @Valid @RequestBody SvgIconCreateRequest svgIconCreateRequest) {
  ...
  @PostMapping("/batch")
  @PreAuthorize("@securityUtil.canManageIcons() or @securityUtil.isAdmin()")
  public ResponseEntity<SvgIconBatchResponse> saveBatchSvgIcons(
      @Valid @RequestBody SvgIconBatchRequest request) {
  ...
  public ResponseEntity<String> getSvgIconContent(
    ...
    return ResponseEntity.ok().header("Content-Type", "image/svg+xml").body(svgContent);
  }

...
public class KoreaderController {
  ...
  public ResponseEntity<?> createUser(
    ...
    return ResponseEntity.status(HttpStatus.FORBIDDEN)
        .body(Map.of("error", "User registration via Koreader is disabled"));
  }
  ...
  public ResponseEntity<KoreaderProgress> getProgress(
    ...
    return ResponseEntity.ok().contentType(MediaType.APPLICATION_JSON).body(progress);
  }
  ...
  public ResponseEntity<?> updateProgress(
      @Parameter(description = "KoReader progress object") @Valid @RequestBody

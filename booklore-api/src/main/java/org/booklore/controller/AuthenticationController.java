...
public class AuthenticationController {
  ...
  public ResponseEntity<?> registerUser(
      @Parameter(description = "User registration request") @RequestBody @Valid
  ...
  public ResponseEntity<Map<String, String>> loginUser(
      @Parameter(description = "User login request") @RequestBody @Valid
  ...
  public ResponseEntity<Map<String, String>> refreshToken(
      @Parameter(description = "Refresh token request") @Valid @RequestBody
  ...
  public ResponseEntity<Map<String, String>> loginRemote(
      @Parameter(description = "Authentication headers") @RequestHeader
    ...
    String name =
        headers.get(appProperties.getRemoteAuth().getHeaderName().toLowerCase(Locale.ROOT));
    String username =
        headers.get(appProperties.getRemoteAuth().getHeaderUser().toLowerCase(Locale.ROOT));
    String email =
        headers.get(appProperties.getRemoteAuth().getHeaderEmail().toLowerCase(Locale.ROOT));
    String groups =
        headers.get(appProperties.getRemoteAuth().getHeaderGroups().toLowerCase(Locale.ROOT));
    log.debug(
        "Remote-Auth: retrieved values from headers: name: {}, username: {}, email: {}, groups: {}",
        name,
        username,
        email,
        groups);

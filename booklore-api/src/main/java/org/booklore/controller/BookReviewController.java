...
public class BookReviewController {
  ...
  @Operation(
      ...
      description =
          "Refresh and retrieve reviews for a specific book. Requires metadata edit permission or admin.")
  ...
  @Operation(
      ...
      description =
          "Delete a specific review by its ID. Requires metadata edit permission or admin.")

...
public class EmailRecipientV2Controller {
  ...
  public ResponseEntity<EmailRecipientV2> createEmailRecipient(
      @Parameter(description = "Email recipient creation request") @RequestBody @Valid
          CreateEmailRecipientRequest createEmailRecipientRequest) {
  ...
  public ResponseEntity<EmailRecipientV2> updateEmailRecipient(
      @Parameter(description = "ID of the email recipient") @PathVariable Long id,
      @Parameter(description = "Email recipient update request") @RequestBody @Valid
          CreateEmailRecipientRequest updateRequest) {

...
public class AdditionalFileController {
  ...
  public ResponseEntity<List<BookFile>> getFilesByIsBook(
      @PathVariable Long bookId, @RequestParam boolean isBook) {
    List<BookFile> files =
  ...
  public ResponseEntity<BookFile> uploadAdditionalFile(
    ...
    BookFile additionalFile =
        fileUploadService.uploadAdditionalFile(bookId, file, isBook, bookType, description);
  ...
  public ResponseEntity<Resource> downloadAdditionalFile(
      @PathVariable Long bookId, @PathVariable Long fileId) throws IOException {
  ...
  public ResponseEntity<Void> deleteAdditionalFile(
      @PathVariable Long bookId, @PathVariable Long fileId) {
  ...
  public ResponseEntity<DetachBookFileResponse> detachFile(
    ...
    return ResponseEntity.ok(
        bookFileDetachmentService.detachBookFile(bookId, fileId, request.copyMetadata()));
  }
}

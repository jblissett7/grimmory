...
public class OidcAuthController {
  ...
  public ResponseEntity<Map<String, String>> handleCallback(
      @RequestBody @Valid OidcCallbackRequest request, HttpServletRequest httpRequest) {
  ...
  public ResponseEntity<Void> handleRedirect(
    ...
    try {
      ...
      fragment
          .append("access_token=")
          .append(URLEncoder.encode(tokens.get("accessToken"), StandardCharsets.UTF_8));
      fragment
          .append("&refresh_token=")
          .append(URLEncoder.encode(tokens.get("refreshToken"), StandardCharsets.UTF_8));

      if (tokens.containsKey("isDefaultPassword")) {
        fragment
            .append("&is_default_password=")
            .append(URLEncoder.encode(tokens.get("isDefaultPassword"), StandardCharsets.UTF_8));
      }

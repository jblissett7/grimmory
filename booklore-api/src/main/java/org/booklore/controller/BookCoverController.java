...
public class BookCoverController {
  ...
  @Operation(
      ...
      description =
          "Upload a cover image for a book from a file. Requires metadata edit permission or admin.")
  ...
  @Operation(
      summary = "Upload audiobook cover image from file",
      description =
  ...
  @Operation(
      summary = "Upload audiobook cover image from URL",
      description =
          "Upload an audiobook cover image for a book from a URL. Requires metadata edit permission or admin.")
  @ApiResponse(responseCode = "200", description = "Audiobook cover image uploaded successfully")
  ...
  @Operation(
      summary = "Regenerate audiobook cover for a book",
      description =
  ...
  @PreAuthorize("@securityUtil.canEditMetadata() or @securityUtil.isAdmin()")
  @CheckBookAccess(bookIdParam = "bookId")
  public void regenerateAudiobookCover(
      @Parameter(description = "ID of the book") @PathVariable Long bookId) {
    bookCoverService.regenerateAudiobookCover(bookId);
  }

  @Operation(
      summary = "Generate custom audiobook cover for a book",
      description =
  ...
  @PreAuthorize("@securityUtil.canEditMetadata() or @securityUtil.isAdmin()")
  @CheckBookAccess(bookIdParam = "bookId")
  public void generateCustomAudiobookCover(
      @Parameter(description = "ID of the book") @PathVariable Long bookId) {
  ...
  @Operation(
      ...
      description =
          "Regenerate cover for a specific book. Requires metadata edit permission or admin.")
  ...
  @Operation(
      ...
      description =
          "Generate a custom cover for a specific book based on its metadata. Requires metadata edit permission or admin.")
  ...
  @Operation(
      ...
      description =
          "Regenerate covers for a list of books. Requires metadata edit permission or admin.")
  @ApiResponse(responseCode = "204", description = "Cover regeneration started successfully")
  @PostMapping("/bulk-regenerate-covers")
  @PreAuthorize("@securityUtil.canBulkRegenerateCover() or @securityUtil.isAdmin()")
  public void regenerateCoversForBooks(
      @Parameter(description = "List of book IDs") @Validated @RequestBody
          BulkBookIdsRequest request) {
  ...
  @PreAuthorize("@securityUtil.canBulkRegenerateCover() or @securityUtil.isAdmin()")
  public void generateCustomCoversForBooks(
      @Parameter(description = "List of book IDs") @Validated @RequestBody
          BulkBookIdsRequest request) {
  ...
  public void bulkUploadCover(
      @Parameter(description = "Cover image file") @RequestParam("file") MultipartFile file,
      @Parameter(description = "Comma-separated book IDs")
          @RequestParam("bookIds")
          @jakarta.validation.constraints.NotEmpty
          java.util.Set<Long> bookIds) {

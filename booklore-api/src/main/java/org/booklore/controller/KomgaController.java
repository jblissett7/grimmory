...
public class KomgaController {
  ...
  private final @Qualifier(JacksonConfig.KOMGA_CLEAN_OBJECT_MAPPER) ObjectMapper
      komgaCleanObjectMapper;
  ...
  public ResponseEntity<String> getAllSeries(
      @Parameter(description = "Library ID filter")
          @RequestParam(required = false, name = "library_id")
          Long libraryId,
      @Parameter(description = "Page number") @RequestParam(defaultValue = "0") int page,
      @Parameter(description = "Page size") @RequestParam(defaultValue = "20") int size,
      @Parameter(description = "Return all books without paging")
          @RequestParam(defaultValue = "false")
          boolean unpaged) {
    KomgaPageableDto<KomgaSeriesDto> result =
        komgaService.getAllSeries(libraryId, page, size, unpaged);
  ...
  public ResponseEntity<Resource> getBookPage(
      ...
      @Parameter(description = "Convert image format (e.g., 'png')") @RequestParam(required = false)
          String convert) {
    ...
    try {
      ...
      return ResponseEntity.ok().header("Content-Type", contentType).body(pageImage);
    } catch (Exception e) {
  ...
  public ResponseEntity<String> getCollections(
      @Parameter(description = "Page number") @RequestParam(defaultValue = "0") int page,
      @Parameter(description = "Page size") @RequestParam(defaultValue = "20") int size,
      @Parameter(description = "Return all collections without paging")
          @RequestParam(defaultValue = "false")
          boolean unpaged) {

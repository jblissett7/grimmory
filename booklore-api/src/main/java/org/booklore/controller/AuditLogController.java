...
public class AuditLogController {
  ...
  @Operation(
      ...
      description = "Retrieve paginated audit logs with optional filters. Requires admin.")
  ...
  public ResponseEntity<Page<AuditLogDto>> getAuditLogs(
      ...
      @Parameter(description = "Filter by username") @RequestParam(required = false)
          String username,
    ...
    if (action == null && userId == null && username == null && from == null && to == null) {
      ...
      logs =
          auditService.getAuditLogs(action, userId, username, from, to, PageRequest.of(page, size));
    }
    return ResponseEntity.ok(logs);
  }

  @Operation(
      summary = "Get distinct usernames",
      description = "Retrieve distinct usernames from audit logs for filtering.")

...
public class UserStatsController {
  ...
  public ResponseEntity<List<ReadingSessionHeatmapResponse>> getHeatmapForYear(
      @RequestParam int year) {
    List<ReadingSessionHeatmapResponse> heatmapData =
        readingSessionService.getSessionHeatmapForYear(year);
  ...
  @Operation(
      ...
      description =
          "Returns daily reading session counts for the authenticated user for a specific year and month")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Heatmap data retrieved successfully"),
    @ApiResponse(responseCode = "401", description = "Unauthorized")
  })
  ...
  public ResponseEntity<List<ReadingSessionHeatmapResponse>> getHeatmapForMonth(
    ...
    List<ReadingSessionHeatmapResponse> heatmapData =
        readingSessionService.getSessionHeatmapForMonth(year, month);
    return ResponseEntity.ok(heatmapData);
  }
  ...
  public ResponseEntity<List<ReadingSessionTimelineResponse>> getTimelineForWeek(
    ...
    List<ReadingSessionTimelineResponse> timelineData =
        readingSessionService.getSessionTimelineForWeek(year, week);
  ...
  @Operation(
      ...
      description =
          "Returns average reading speed (progress per minute) over time for a specific year")
  @ApiResponses({
  ...
  @Operation(
      ...
      description =
          "Returns reading activity distribution by day of week. Can be filtered by year and/or month.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<List<FavoriteReadingDaysResponse>> getFavoriteReadingDays(
      @RequestParam(required = false) Integer year, @RequestParam(required = false) Integer month) {
    List<FavoriteReadingDaysResponse> favoriteDays =
        readingSessionService.getFavoriteReadingDays(year, month);
  ...
  @PreAuthorize("@securityUtil.canAccessUserStats() or @securityUtil.isAdmin()")
  public ResponseEntity<List<CompletionTimelineResponse>> getCompletionTimeline(
      @RequestParam int year) {
  ...
  public ResponseEntity<List<BookCompletionHeatmapResponse>> getBookCompletionHeatmap() {
    List<BookCompletionHeatmapResponse> heatmapData =
        readingSessionService.getBookCompletionHeatmap();
    return ResponseEntity.ok(heatmapData);
  }

  @Operation(
      summary = "Get page turner scores",
      description =
          "Returns engagement/grip scores for completed books based on reading session patterns")
  @ApiResponses({
  ...
  @Operation(
      summary = "Get completion race data",
      description =
          "Returns reading session progress data for completed books in a given year, for visualizing completion races")
  @ApiResponses({
  ...
  @Operation(
      summary = "Get book distribution statistics",
      description =
          "Returns rating, progress, and read status distributions for the authenticated user's library")
  @ApiResponses({
  ...
  @Operation(
      summary = "Get session scatter data",
      description = "Returns individual session data points for scatter plot visualization")
  @ApiResponses({
  ...
  @Operation(
      ...
      description =
          "Returns current streak, longest streak, total reading days, and last 52 weeks of daily reading activity")
  @ApiResponses({
  ...
  @Operation(
      summary = "Get book timeline for a year",
      description = "Returns the reading lifespan of each book the user read in a given year")
  @ApiResponses({
  ...
  @Operation(
      summary = "Get weekly listening trend",
      description = "Returns weekly listening hours over a number of past weeks")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "Weekly listening trend retrieved successfully"),
    @ApiResponse(responseCode = "401", description = "Unauthorized")
  })
  ...
  @Operation(
      summary = "Get audiobook completion progress",
      description =
          "Returns in-progress audiobooks with completion percentages and overall library stats")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "Listening completion data retrieved successfully"),
    @ApiResponse(responseCode = "401", description = "Unauthorized")
  })
  ...
  @Operation(
      summary = "Get monthly audiobook pace",
      description = "Returns audiobooks completed per month with listening duration")
  @ApiResponses({
  ...
  @Operation(
      summary = "Get audiobook finish rate funnel",
      description =
          "Returns how many audiobooks reached each progress milestone (25%, 50%, 75%, finished)")
  @ApiResponses({

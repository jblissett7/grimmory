...
@Converter
@Slf4j
public class AudioFileChapterListConverter
    implements AttributeConverter<List<AudioFileChapter>, String> {

  private static final ObjectMapper objectMapper = new ObjectMapper();
  private static final TypeReference<List<AudioFileChapter>> LIST_TYPE_REF =
      new TypeReference<>() {};

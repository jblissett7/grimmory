...
@Converter
@Slf4j
public class BookRecommendationIdsListConverter
    implements AttributeConverter<Set<BookRecommendationLite>, String> {

  private static final ObjectMapper objectMapper = new ObjectMapper();
  private static final TypeReference<Set<BookRecommendationLite>> SET_TYPE_REF =
      new TypeReference<>() {};
  ...
  public Set<BookRecommendationLite> convertToEntityAttribute(String json) {
    ...
    try {
      ...
      log.error(
          "Corrupted similar_books_json found in database. Returning empty set. JSON: {}", json, e);
      return Set.of();
    }
  }
}

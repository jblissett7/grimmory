...
public class TelemetryService {
  ...
  public BookloreTelemetry collectTelemetry() {
    ...
    BookloreTelemetry.BookStatistics bookStatistics =
        BookloreTelemetry.BookStatistics.builder()
            .totalBooks(bookRepository.count())
            .bookCountByType(getBookFileTypeCounts())
            .build();

    List<BookloreTelemetry.LibraryStatistics> libraryStatisticsList =
        libraryRepository.findAll().stream()
            .map(this::mapLibraryStatistics)
            .collect(Collectors.toList());

    String[] enabledMetadataProviders =
        getEnabledMetadataProviders(settings.getMetadataProviderSettings());
    String[] enabledReviewMetadataProviders =
        getEnabledReviewMetadataProviders(settings.getMetadataPublicReviewsSettings());
    ...
    return BookloreTelemetry.builder()
        ...
        .userStatistics(
            BookloreTelemetry.UserStatistics.builder()
                ...
                .build())
        .metadataStatistics(
            BookloreTelemetry.MetadataStatistics.builder()
                .enabledMetadataProviders(enabledMetadataProviders)
                .enabledReviewMetadataProviders(enabledReviewMetadataProviders)
                .saveMetadataToFile(
                    settings
                        .getMetadataPersistenceSettings()
                        .getSaveToOriginalFile()
                        .isAnyFormatEnabled())
                .moveFileViaPattern(
                    settings.getMetadataPersistenceSettings().isMoveFilesToLibraryPattern())

...
public class HardcoverMoodFilter {
  ...
  public static final Set<String> RECOGNIZED_MOODS =
      Set.of(
          "adventurous",
          "challenging",
          "dark",
  ...
  public static Set<String> filterMoodsWithCounts(
      Map<String, List<HardcoverCachedTag>> cachedTags) {
  ...
  public static Set<String> filterMoodsWithCounts(List<HardcoverCachedTag> moodTags) {
    ...
    List<HardcoverCachedTag> filteredMoods =
        moodTags.stream()
    ...
    log.debug(
        "Filtered moods from {} to {} (max count: {}, threshold: {})",
        moodTags.size(),
        filteredMoods.size(),
        maxCount,
        minCountThreshold);
  ...
  public static Set<String> filterGenresWithCounts(
      Map<String, List<HardcoverCachedTag>> cachedTags) {
    if (cachedTags == null || cachedTags.isEmpty()) {
      return Collections.emptySet();
    }

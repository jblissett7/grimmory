...
public class HardcoverBookSearchService {
  ...
  public HardcoverBookSearchService(AppSettingService appSettingService) {
    ...
    this.restClient = RestClient.builder().baseUrl("https://api.hardcover.app/v1/graphql").build();
  }
  ...
  public HardcoverBookDetails fetchBookDetails(int bookId) {
    ...
    HardcoverBookDetailsResponse response =
        executeRequest(body, HardcoverBookDetailsResponse.class, apiToken);
  ...
  private String getApiToken() {
    String apiToken =
        appSettingService.getAppSettings().getMetadataProviderSettings().getHardcover().getApiKey();

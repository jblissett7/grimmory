...
public class PdfAnnotationService {
  ...
  public Optional<String> getAnnotations(Long bookId) {
    ...
    return pdfAnnotationRepository
  ...
  public void saveAnnotations(Long bookId, String data) {
    Long userId = getCurrentUserId();
    Optional<PdfAnnotationEntity> existing =
        pdfAnnotationRepository.findByBookIdAndUserId(bookId, userId);
    ...
    if (existing.isPresent()) {
      ...
      PdfAnnotationEntity entity =
          PdfAnnotationEntity.builder()

...
public class BookNoteService {
  ...
  public List<BookNote> getNotesForBook(Long bookId) {
    ...
    return bookNoteRepository
        .findByBookIdAndUserIdOrderByUpdatedAtDesc(bookId, currentUser.getId())
        .stream()
        .map(mapper::toDto)
  ...
  public BookNote createOrUpdateNote(CreateBookNoteRequest request) {
    ...
    BookLoreUserEntity user =
        userRepository
            ...
            .orElseThrow(
                () -> new EntityNotFoundException("User not found: " + currentUser.getId()));
    ...
    if (request.getId() != null) {
      noteEntity =
          bookNoteRepository
              .findByIdAndUserId(request.getId(), currentUser.getId())
  ...
  public void deleteNote(Long noteId) {
    ...
    BookNoteEntity note =
        bookNoteRepository
            .findByIdAndUserId(noteId, currentUser.getId())

...
public class ShelfService {
  ...
  public Shelf createShelf(ShelfCreateRequest request) {
    ...
    auditService.log(
        AuditAction.SHELF_CREATED,
        "Shelf",
        shelfEntity.getId(),
        "Created shelf: " + request.getName());
    return result;
  }
  ...
  public Shelf getUserKoboShelf() {
    Long userId = getAuthenticatedUserId();
    Optional<ShelfEntity> koboShelf =
        shelfRepository.findByUserIdAndName(userId, ShelfType.KOBO.getName());

...
public class DefaultUserSettingsProvider {
  ...
  private final Map<UserSettingKey, Supplier<Object>> defaultSettings =
      new EnumMap<>(UserSettingKey.class);
  ...
  public void init() {
    ...
    defaultSettings.put(
        UserSettingKey.NEW_PDF_READER_SETTING, this::buildDefaultNewPdfReaderSetting);
    defaultSettings.put(
        UserSettingKey.SIDEBAR_LIBRARY_SORTING, this::buildDefaultSidebarLibrarySorting);
    defaultSettings.put(
        UserSettingKey.SIDEBAR_SHELF_SORTING, this::buildDefaultSidebarShelfSorting);
    defaultSettings.put(
        UserSettingKey.SIDEBAR_MAGIC_SHELF_SORTING, this::buildDefaultSidebarMagicShelfSorting);
    defaultSettings.put(
        UserSettingKey.ENTITY_VIEW_PREFERENCES, this::buildDefaultEntityViewPreferences);
  ...
  private BookLoreUser.UserSettings.EntityViewPreferences buildDefaultEntityViewPreferences() {
    return BookLoreUser.UserSettings.EntityViewPreferences.builder()
        .global(
            BookLoreUser.UserSettings.GlobalPreferences.builder()
                .sortKey("title")
                .sortDir("ASC")
                .view("GRID")
                .coverSize(1.0F)

...
public class BookVectorService {
  ...
  private void addTextFeatures(
      Map<String, Double> features, String prefix, String text, double weight) {
    String[] words =
  ...
  public List<ScoredBook> findTopKSimilar(
      double[] targetVector, List<ScoredBook> candidates, int k) {

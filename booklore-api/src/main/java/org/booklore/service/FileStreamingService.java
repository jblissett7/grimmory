...
public class FileStreamingService {
  ...
  public void streamWithRangeSupport(
      Path filePath, String contentType, HttpServletRequest request, HttpServletResponse response)
      throws IOException {
  ...
  // STREAM BYTES
  // ------------------------------------------------------------
  private void streamBytes(Path path, long start, long end, OutputStream out) throws IOException {

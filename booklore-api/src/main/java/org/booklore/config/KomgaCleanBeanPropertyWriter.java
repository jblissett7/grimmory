...
/**
 * Custom BeanPropertyWriter that handles clean mode filtering. When clean mode is enabled: - Fields
 * ending with "Lock" are excluded - Null values are excluded - Empty arrays/collections are
 * excluded
 */

...
public class EpubStreamingJwtFilter extends OncePerRequestFilter {
  ...
  private static final Pattern EPUB_STREAMING_ENDPOINT_PATTERN =
      Pattern.compile("/api/v1/epub/\\d+/file/.*");
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      response.sendError(
          HttpServletResponse.SC_UNAUTHORIZED, "Authentication failed: " + ex.getMessage());
      return;
    }

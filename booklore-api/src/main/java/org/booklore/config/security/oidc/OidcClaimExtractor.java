...
public class OidcClaimExtractor {
  ...
  public OidcUserClaims extractClaims(
      JWTClaimsSet claims, OidcProviderDetails.ClaimMapping mapping, Map<String, Object> userInfo) {
  ...
  private List<String> getListClaim(
      JWTClaimsSet claims,

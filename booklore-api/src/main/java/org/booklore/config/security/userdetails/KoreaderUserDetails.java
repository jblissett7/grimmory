...
public class KoreaderUserDetails implements UserDetails {
  ...
  @Getter private final boolean syncEnabled;
  @Getter private final boolean syncWithBookloreReader;
  @Getter private final Long bookLoreUserId;
  private final Collection<? extends GrantedAuthority> authorities;

  public KoreaderUserDetails(
      String username,
      String password,
      boolean syncEnabled,

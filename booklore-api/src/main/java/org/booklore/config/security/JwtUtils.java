...
public class JwtUtils {
  ...
  @Getter public static final long accessTokenExpirationMs = 1000L * 60 * 60 * 10; // 10 hours
  @Getter public static final long refreshTokenExpirationMs = 1000L * 60 * 60 * 24 * 30; // 30 days

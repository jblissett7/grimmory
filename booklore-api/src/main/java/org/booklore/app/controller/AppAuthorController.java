...
public class AppAuthorController {
  ...
  public ResponseEntity<AppPageResponse<AppAuthorSummary>> getAuthors(
    ...
    return ResponseEntity.ok(
        mobileAuthorService.getAuthors(page, size, sort, dir, libraryId, search, hasPhoto));
  }

  @GetMapping("/{authorId}")
  public ResponseEntity<AppAuthorDetail> getAuthorDetail(@PathVariable Long authorId) {

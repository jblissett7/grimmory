...
public class AppBookController {
  ...
  public ResponseEntity<AppPageResponse<AppBookSummary>> getBooks(
    ...
    return ResponseEntity.ok(
        mobileBookService.getBooks(
            page, size, sort, dir, libraryId, shelfId, status, search, fileType, minRating,
            maxRating, authors, language));
  }

  @GetMapping("/{bookId}")
  public ResponseEntity<AppBookDetail> getBookDetail(@PathVariable Long bookId) {
  ...
  public ResponseEntity<Void> updateStatus(
      @PathVariable Long bookId, @Valid @RequestBody UpdateStatusRequest request) {
  ...
  public ResponseEntity<Void> updateRating(
      @PathVariable Long bookId, @Valid @RequestBody UpdateRatingRequest request) {

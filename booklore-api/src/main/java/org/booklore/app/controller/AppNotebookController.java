...
public class AppNotebookController {
  ...
  public ResponseEntity<AppPageResponse<AppNotebookEntry>> getEntriesForBook(
    ...
    return ResponseEntity.ok(
        mobileNotebookService.getEntriesForBook(bookId, page, size, types, search, sort));
  }
  ...
  public ResponseEntity<Void> deleteEntry(@PathVariable Long entryId, @RequestParam String type) {

...
public class AppSeriesController {
  ...
  public ResponseEntity<AppPageResponse<AppSeriesSummary>> getSeries(
    ...
    AppPageResponse<AppSeriesSummary> response =
        mobileSeriesService.getSeries(page, size, sort, dir, libraryId, search, inProgressOnly);
  ...
  public ResponseEntity<AppPageResponse<AppBookSummary>> getSeriesBooks(
    ...
    AppPageResponse<AppBookSummary> response =
        mobileSeriesService.getSeriesBooks(seriesName, page, size, sort, dir, libraryId);

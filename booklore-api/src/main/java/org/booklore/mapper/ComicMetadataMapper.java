...
public interface ComicMetadataMapper {
  ...
  @Mapping(
      target = "pencillers",
      source = "creatorMappings",
      qualifiedByName = "pencillersToStrings")
  ...
  @Mapping(
      target = "coverArtists",
      source = "creatorMappings",
      qualifiedByName = "coverArtistsToStrings")
  ...
  default Set<String> creatorsToStringsByRole(
      Set<ComicCreatorMappingEntity> mappings, ComicCreatorRole role) {

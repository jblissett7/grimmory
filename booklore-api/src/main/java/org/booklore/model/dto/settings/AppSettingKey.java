...
public enum AppSettingKey {
  ...
  OIDC_AUTO_PROVISION_DETAILS(
      "oidc_auto_provision_details", true, false, List.of(PermissionType.ADMIN)),
  OIDC_SESSION_DURATION_HOURS(
      "oidc_session_duration_hours", false, false, List.of(PermissionType.ADMIN)),
  ...
  QUICK_BOOK_MATCH(
      ...
      true,
      false,
      List.of(PermissionType.ADMIN, PermissionType.MANAGE_METADATA_CONFIG)),
  ...
  METADATA_MATCH_WEIGHTS(
      ...
      false,
      List.of(PermissionType.ADMIN, PermissionType.MANAGE_METADATA_CONFIG)),
  METADATA_PERSISTENCE_SETTINGS(
      "metadata_persistence_settings_v2",
      true,
      false,
      List.of(PermissionType.ADMIN, PermissionType.MANAGE_METADATA_CONFIG)),
  METADATA_PUBLIC_REVIEWS_SETTINGS(
      "metadata_public_reviews_settings",
      true,
      false,
      List.of(PermissionType.ADMIN, PermissionType.MANAGE_METADATA_CONFIG)),
  ...
  METADATA_DOWNLOAD_ON_BOOKDROP(
      ...
      false,
      List.of(PermissionType.ADMIN, PermissionType.MANAGE_METADATA_CONFIG)),
  METADATA_PROVIDER_SPECIFIC_FIELDS(
      "metadata_provider_specific_fields",
      true,
      false,
      List.of(PermissionType.ADMIN, PermissionType.MANAGE_METADATA_CONFIG)),
  ...
  COVER_CROPPING_SETTINGS(
      "cover_cropping_settings",
      true,
      false,
      List.of(PermissionType.ADMIN, PermissionType.MANAGE_GLOBAL_PREFERENCES)),
  AUTO_BOOK_SEARCH(
      "auto_book_search",
      false,
      false,
      List.of(PermissionType.ADMIN, PermissionType.MANAGE_GLOBAL_PREFERENCES)),
  SIMILAR_BOOK_RECOMMENDATION(
      "similar_book_recommendation",
      false,
      false,
      List.of(PermissionType.ADMIN, PermissionType.MANAGE_GLOBAL_PREFERENCES)),
  PDF_CACHE_SIZE_IN_MB(
      "pdf_cache_size_in_mb",
      false,
      false,
      List.of(PermissionType.ADMIN, PermissionType.MANAGE_GLOBAL_PREFERENCES)),
  ...
  AppSettingKey(
      String dbKey, boolean isJson, boolean isPublic, List<PermissionType> requiredPermissions) {
    this.dbKey = dbKey;
    this.isJson = isJson;

...
public class KomgaSeriesMetadataDto {
  ...
  @Builder.Default private List<KomgaAlternateTitleDto> alternateTitles = new ArrayList<>();
  private Boolean alternateTitlesLock;

  @Builder.Default private List<KomgaWebLinkDto> links = new ArrayList<>();
  private Boolean linksLock;

  @Builder.Default private List<String> sharingLabels = new ArrayList<>();

...
public enum UserPermission {
  ...
  public static void copyFromEntityToDto(
      UserPermissionsEntity source, BookLoreUser.UserPermissions target) {
  ...
  public static void copyFromRequestToEntity(
      UserUpdateRequest.Permissions source, UserPermissionsEntity target) {
    if (source == null || target == null) return;
    for (UserPermission permission : values()) {

...
@Repository
public interface UserBookFileProgressRepository
    extends JpaRepository<UserBookFileProgressEntity, Long> {
  ...
  List<UserBookFileProgressEntity> findByUserIdAndBookFileBookIdIn(
      @Param("userId") Long userId, @Param("bookIds") Iterable<Long> bookIds);
